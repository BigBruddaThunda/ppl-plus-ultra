...
blocks: ♨️ 🏗 🧈 🧩 🪫 🚂
---
# ➕ Pull-Up (Overhand Grip) — Plus Intense ➕

## Balance Basics — Plus focus (Intense) · 40-50 min
...
═══
## 2) 🏗 Reformance
Subcode: ⚖🏛➕🔴 (Reformance | Plus | Basics | Intense)
├─ 11 ➕ Wide-Grip Pull-Up (Teres Focus) (corrective, address the weak link)
│  Set 1: ⚖ 50% × 13 (prehab)
...
├─ 11 ➕ Pull-Up (Overhand Grip) (high effort, push the pace)
...
├─ 12 ➕ Deadlift (Conventional) (stress out, cathartic discharge)
│  Set 1: ⚖ 50% × 12 (deload)
Rest: 75s
═══
## 6) 🚂 Junction
