...
## Balance Basics — Push focus (Fun) · 40-50 min
...
├─ 11 🛒 Plyometric Push-Up (Hands Leave Ground) (try the unfamiliar version, explore the range)
│  Set 1: ⚖ 55% × 11 (discovery set)
Rest: 75s
═══
## 4) 🏖 Sandbox
Subcode: ⚖🏛🛒🟡 (Sandbox | Push | Basics | Fun)
├─ 11 🛒 Depth Push-Up (Drop to Floor) (explore within constraints, choose your variation)
