...
## Balance Basics — Pull focus (Intense) · 40-50 min
...
├─ 12 🪡 Log Press (high effort, push the pace)
...
├─ 11 🪡 Push Jerk (Barbell) (high effort, push the pace)
...
├─ 12 🪡 Power Snatch (all-out, leave nothing in reserve)
...
├─ 12 🪡 Power Snatch (stress out, cathartic discharge)
│  Set 1: ⚖ 50% × 12 (deload)
Rest: 37s
═══
## 7) 🚂 Junction
