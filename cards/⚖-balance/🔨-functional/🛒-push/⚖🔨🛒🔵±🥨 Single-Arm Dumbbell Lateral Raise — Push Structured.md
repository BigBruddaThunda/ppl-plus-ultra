...
blocks: ♨️ 🏗 🧈 🧩 🪫 🚂
---
# 🛒 Single-Arm Dumbbell Lateral Raise — Push Structured 🛒

## Balance Functional — Push focus (Structured) · 40-50 min
...
├─ 12 🛒 Single-Arm Cable Chest Fly (prescribed, track sets and reps)
│  Set 1: ⚖ 50% × 12 (pattern prep)
Rest: 60s
═══
## 2) 🏗 Reformance
Subcode: ⚖🔨🛒🔵 (Reformance | Push | Functional | Structured)
...
├─ 11 🛒 Single-Arm Dumbbell Lateral Raise (prescribed, track sets and reps)
...
├─ 13 🛒 Alternating Dumbbell Curl (full range, different angle)
