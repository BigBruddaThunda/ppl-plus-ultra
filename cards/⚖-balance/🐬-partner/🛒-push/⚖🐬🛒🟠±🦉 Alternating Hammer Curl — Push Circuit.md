...
## Balance Partner — Push focus (Circuit) · 40-50 min
...
═══
## 2) 🏗 Reformance
Subcode: ⚖🐬🛒🟠 (Reformance | Push | Partner | Circuit)
├─ 11 🛒 Alternating Dumbbell Front Raise (corrective, address the weak link)
│  Set 1: ⚖ 50% × 13 (prehab)
...
│  Station 3: 🛒 Alternating Dumbbell Front Raise × 11 (station rotation, keep moving)
│  Station 4: 🛒 Alternating Dumbbell Curl × 11 (station rotation, keep moving)
