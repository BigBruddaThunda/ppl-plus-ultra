...
blocks: ♨️ 🏗 🧈 🧩 🪫 🚂
---
# ➖ Half Turkish Get-Up (To Elbow) — Ultra Structured ➖

## Balance Time — Ultra focus (Structured) · 40-50 min
...
├─ 12 ➖ Single-Foot In Each Box (Forward) (prescribed, track sets and reps)
│  Set 1: ⚖ 50% × 12 (pattern prep)
Rest: 60s
═══
## 2) 🏗 Reformance
Subcode: ⚖⌛➖🔵 (Reformance | Ultra | Time | Structured)
├─ 11 ➖ Turkish Get-Up (Full) (corrective, address the weak link)
│  Set 1: ⚖ 50% × 12 (prehab)
...
├─ 11 ➖ Half Turkish Get-Up (To Elbow) (prescribed, track sets and reps)
...
═══
## 4) 🧩 Supplemental
Subcode: ⚖⌛➖🔵 (Supplemental | Ultra | Time | Structured)
