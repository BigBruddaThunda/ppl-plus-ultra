...
## Balance Challenge — Push focus (Intense) · 40-50 min
...
═══
## 2) 🏗 Reformance
Subcode: ⚖🪐🛒🔴 (Reformance | Push | Challenge | Intense)
├─ 11 🛒 Sandbag Shouldering (corrective, address the weak link)
│  Set 1: ⚖ 50% × 13 (prehab)
...
├─ 11 🛒 Atlas Stone Load (Shoulder Position) (high effort, push the pace)
...
├─ 13 🛒 Push Jerk (Barbell) (full range, different angle)
...
├─ 12 🛒 Low-to-High Cable Fly (stress out, cathartic discharge)
│  Set 1: ⚖ 50% × 12 (deload)
Rest: 75s
═══
## 6) 🚂 Junction
