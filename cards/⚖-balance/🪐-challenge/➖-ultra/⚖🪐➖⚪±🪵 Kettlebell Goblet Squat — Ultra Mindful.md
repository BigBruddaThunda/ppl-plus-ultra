...
blocks: ♨️ 🏗 🧈 🧩 🪫 🚂
---
# ➖ Kettlebell Goblet Squat — Ultra Mindful ➖

## Balance Challenge — Ultra focus (Mindful) · 40-50 min
...
═══
## 2) 🏗 Reformance
Subcode: ⚖🪐➖⚪ (Reformance | Ultra | Challenge | Mindful)
├─ 11 ➖ Sprint (10-30 meters) (corrective, address the weak link)
│  Set 1: ⚖ 50% × 13 (prehab)
...
├─ 11 ➖ Kettlebell Goblet Squat (4s eccentric, breath-paced)
...
├─ 12 ➖ Two Feet In Each Box (Forward) (parasympathetic, tension down)
│  Set 1: ⚖ 50% × 12 (deload)
Rest: 75s
═══
## 6) 🚂 Junction
