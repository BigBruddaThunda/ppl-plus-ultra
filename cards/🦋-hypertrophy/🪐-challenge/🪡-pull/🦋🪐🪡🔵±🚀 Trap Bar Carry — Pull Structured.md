...
═══
## 2) ▶️ Primer
Subcode: 🦋🪐🪡🔵 (Primer | Pull | Challenge | Structured)
├─ 10 🪡 Chest-Supported Row (Elbow Out) (tight setup, crisp intent)
...
═══
## 4) 🗿 Sculpt
Subcode: 🦋🪐🪡🔵 (Sculpt | Pull | Challenge | Structured)
├─ 12 🪡 Cable Row (High Elbow) (angles, tension, volume)
│  Set 1: 🦋 65% × 12 (shaping)
│  Set 2: 🦋 65% × 12 (carving)
Rest: 60s
═══
