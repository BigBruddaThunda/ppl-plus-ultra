...
## Hypertrophy Challenge — Pull focus (Teaching) · 55-70 min
...
├─ 12 🪡 Cable Pullover (coached, check form before adding load)
│  Set 1: 🦋 50% × 12 (pattern prep)
Rest: 60s
═══
## 2) ▶️ Primer
Subcode: 🦋🪐🪡⚫ (Primer | Pull | Challenge | Teaching)
...
═══
## 4) 🗿 Sculpt
Subcode: 🦋🪐🪡⚫ (Sculpt | Pull | Challenge | Teaching)
...
═══
## 6) 🪫 Release
Subcode: 🦋🪐🪡⚫ (Release | Pull | Challenge | Teaching)
