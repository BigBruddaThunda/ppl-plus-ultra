...
blocks: ♨️ ▶️ 🧈 🗿 🪞/🧩 🪫 🚂
---
# 🪡 Behind-the-Neck Lat Pulldown (Teres Focus) — Pull Fun 🪡

## Hypertrophy Challenge — Pull focus (Fun) · 55-70 min
...
├─ 12 🪡 Wide-Grip Lat Pulldown (Teres Focus) (explore, stay within constraints)
│  Set 1: 🦋 50% × 12 (pattern prep)
Rest: 60s
═══
## 2) 🧈 Bread & Butter
Subcode: 🦋🪐🪡🟡 (Bread & Butter | Pull | Challenge | Fun)
├─ 10 🪡 Behind-the-Neck Lat Pulldown (Teres Focus) (explore, stay within constraints)
...
├─ 10 🪡 Preacher Curl Machine (try the unfamiliar version, explore the range)
│  Set 1: 🦋 55% × 10 (discovery set)
Rest: 60s
═══
## 4) 🏖 Sandbox
Subcode: 🦋🪐🪡🟡 (Sandbox | Pull | Challenge | Fun)
├─ 10 🪡 Behind-the-Neck Lat Pulldown (Teres Focus) (explore within constraints, choose your variation)
