...
blocks: ♨️ ▶️ 🧈 🗿 🪞/🧩 🪫 🚂
---
# ➖ Half Turkish Get-Up (To Elbow) — Ultra Teaching ➖

## Hypertrophy Challenge — Ultra focus (Teaching) · 55-70 min
...
├─ 12 ➖ Turkish Get-Up (Full) (coached, check form before adding load)
│  Set 1: 🦋 50% × 12 (pattern prep)
Rest: 90s
═══
## 2) 🛠 Craft
Subcode: 🦋🪐➖⚫ (Craft | Ultra | Challenge | Teaching)
├─ 10 ➖ Kettlebell Goblet Squat (coach: check grip width, elbow angle, foot pressure)
...
├─ 10 ➖ Half Turkish Get-Up (To Elbow) (coached, check form before adding load)
...
├─ 12 ➖ Turkish Get-Up (To Kneeling) (high rep, low load, neural memory)
