...
## Hypertrophy Challenge — Ultra focus (Intense) · 55-70 min
...
├─ 12 ➖ Turkish Get-Up (Full) (high effort, push the pace)
...
├─ 10 ➖ Kettlebell Goblet Squat (high effort, push the pace)
...
═══
## 4) 🗿 Sculpt
Subcode: 🦋🪐➖🔴 (Sculpt | Ultra | Challenge | Intense)
...
═══
## 5) 🪞 Vanity
Subcode: 🦋🪐➖🔴 (Vanity | Ultra | Challenge | Intense)
├─ 14 ➖ Turkish Get-Up (To Seated) (pump work, mirror muscles, honest)
...
├─ 12 ➖ Turkish Get-Up (To Seated) (stress out, cathartic discharge)
│  Set 1: 🦋 50% × 12 (deload)
Rest: 60s
═══
## 7) 🚂 Junction
