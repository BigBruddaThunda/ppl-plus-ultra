...
## Hypertrophy Challenge — Push focus (Bodyweight) · 55-70 min
...
═══
## 2) ▶️ Primer
Subcode: 🦋🪐🛒🟢 (Primer | Push | Challenge | Bodyweight)
...
├─ 10 🛒 Single-Arm Cable Rear Delt Fly (bodyweight, no external load needed)
...
═══
## 4) 🗿 Sculpt
Subcode: 🦋🪐🛒🟢 (Sculpt | Push | Challenge | Bodyweight)
...
═══
## 6) 🪫 Release
Subcode: 🦋🪐🛒🟢 (Release | Push | Challenge | Bodyweight)
