...
## Hypertrophy Challenge — Push focus (Technical) · 55-70 min
...
├─ 12 🛒 Sandbag Shouldering (precision, quality over volume)
...
├─ 10 🛒 Atlas Stone Load (Shoulder Position) (precision, quality over volume)
...
═══
## 4) 🗿 Sculpt
Subcode: 🦋🪐🛒🟣 (Sculpt | Push | Challenge | Technical)
├─ 12 🛒 Push Jerk (Barbell) (angles, tension, volume)
│  Set 1: 🦋 65% × 12 (shaping)
│  Set 2: 🦋 65% × 12 (carving)
Rest: 60s
═══
...
├─ 12 🛒 Low-to-High Cable Fly (smooth tempo, downshift)
│  Set 1: 🦋 50% × 12 (deload)
Rest: 60s
═══
## 7) 🚂 Junction
