...
blocks: ♨️ ▶️ 🧈 🗿 🪞/🧩 🪫 🚂
---
# ➕ Neck Rotation (Bodyweight) — Plus Circuit ➕

## Hypertrophy Challenge — Plus focus (Circuit) · 55-70 min
...
├─ 12 ➕ Half-Kneeling Cable Chop (station rotation, keep moving)
│  Set 1: 🦋 50% × 12 (pattern prep)
Rest: 60s
═══
## 2) ▶️ Primer
Subcode: 🦋🪐➕🟠 (Primer | Plus | Challenge | Circuit)
...
│  Station 1: ➕ Neck Rotation (Bodyweight) × 10 (station rotation, keep moving)
│  Station 2: ➕ Half-Kneeling Cable Chop × 10 (station rotation, keep moving)
│  Station 3: ➕ Single-Arm Face Pull × 10 (station rotation, keep moving)
│  Station 4: ➕ Aquaman (Alternating Superman) × 10 (station rotation, keep moving)
