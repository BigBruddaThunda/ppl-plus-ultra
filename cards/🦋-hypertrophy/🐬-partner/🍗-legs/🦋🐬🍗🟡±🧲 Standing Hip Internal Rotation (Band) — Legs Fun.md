...
## Hypertrophy Partner — Legs focus (Fun) · 55-70 min
...
═══
## 2) ▶️ Primer
Subcode: 🦋🐬🍗🟡 (Primer | Legs | Partner | Fun)
...
├─ 10 🍗 Standing Hip Internal Rotation (Band) (explore, stay within constraints)
...
═══
## 4) 🗿 Sculpt
Subcode: 🦋🐬🍗🟡 (Sculpt | Legs | Partner | Fun)
...
═══
## 6) 🪫 Release
Subcode: 🦋🐬🍗🟡 (Release | Legs | Partner | Fun)
