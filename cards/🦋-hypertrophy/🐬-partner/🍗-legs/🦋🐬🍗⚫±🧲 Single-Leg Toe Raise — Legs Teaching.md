...
## Hypertrophy Partner — Legs focus (Teaching) · 55-70 min
...
├─ 12 🍗 Half-Kneeling Hip Flexor Stretch (coached, check form before adding load)
│  Set 1: 🦋 50% × 12 (pattern prep)
Rest: 60s
═══
## 2) ▶️ Primer
Subcode: 🦋🐬🍗⚫ (Primer | Legs | Partner | Teaching)
...
├─ 10 🍗 Single-Leg Toe Raise (coached, check form before adding load)
...
═══
## 4) 🗿 Sculpt
Subcode: 🦋🐬🍗⚫ (Sculpt | Legs | Partner | Teaching)
...
═══
## 6) 🪫 Release
Subcode: 🦋🐬🍗⚫ (Release | Legs | Partner | Teaching)
