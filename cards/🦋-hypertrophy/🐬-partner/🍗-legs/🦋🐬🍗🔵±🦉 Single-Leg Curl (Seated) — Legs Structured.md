...
## Hypertrophy Partner — Legs focus (Structured) · 55-70 min
...
├─ 12 🍗 Half-Kneeling Hip Flexor Stretch (prescribed, track sets and reps)
│  Set 1: 🦋 50% × 12 (pattern prep)
Rest: 60s
═══
## 2) ▶️ Primer
Subcode: 🦋🐬🍗🔵 (Primer | Legs | Partner | Structured)
...
├─ 10 🍗 Single-Leg Curl (Seated) (prescribed, track sets and reps)
...
═══
## 4) 🗿 Sculpt
Subcode: 🦋🐬🍗🔵 (Sculpt | Legs | Partner | Structured)
