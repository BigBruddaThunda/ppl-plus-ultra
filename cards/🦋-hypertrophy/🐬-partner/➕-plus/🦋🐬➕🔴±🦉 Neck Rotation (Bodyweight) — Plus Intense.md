...
## Hypertrophy Partner — Plus focus (Intense) · 55-70 min
...
├─ 10 ➕ Single-Leg Box Jump (tight setup, crisp intent)
...
├─ 12 ➕ Split Jump (Alternating) (full range, different angle)
...
├─ 12 ➕ Single-Leg Broad Jump (all-out, leave nothing in reserve)
