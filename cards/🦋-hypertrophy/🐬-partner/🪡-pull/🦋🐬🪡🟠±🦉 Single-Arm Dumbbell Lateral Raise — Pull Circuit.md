...
blocks: ♨️ ▶️ 🧈 🗿 🪞/🧩 🪫 🚂
---
# 🪡 Single-Arm Dumbbell Lateral Raise — Pull Circuit 🪡

## Hypertrophy Partner — Pull focus (Circuit) · 55-70 min
...
═══
## 2) ▶️ Primer
Subcode: 🦋🐬🪡🟠 (Primer | Pull | Partner | Circuit)
...
│  Station 2: 🪡 Single-Arm Face Pull × 10 (station rotation, keep moving)
│  Station 3: 🪡 Aquaman (Alternating Superman) × 10 (station rotation, keep moving)
│  Station 4: 🪡 Single-Leg Hip Thrust (Barbell) × 10 (station rotation, keep moving)
