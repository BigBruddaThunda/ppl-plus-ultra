...
## Hypertrophy Partner — Pull focus (Structured) · 55-70 min

**CODE:** 🦋🐬🪡🔵

> "Hit every set at the prescribed rep count. Volume is the driver."

*Flexibility / Mobility: Follow the restoration sequence as prescribed — each position has a purpose*
═══
## 1) ♨️ Warm-Up — 🦉 logos
...
═══
## 2) ▶️ Primer
Subcode: 🦋🐬🪡🔵 (Primer | Pull | Partner | Structured)
...
├─ 10 🪡 Single-Arm Cable Rear Delt Fly (prescribed, track sets and reps)
...
═══
## 4) 🗿 Sculpt
Subcode: 🦋🐬🪡🔵 (Sculpt | Pull | Partner | Structured)
