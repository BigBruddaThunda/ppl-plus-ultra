...
## Hypertrophy Aesthetic — Legs focus (Teaching) · 55-70 min
...
├─ 10 🍗 Step-Down (Eccentric) (coach: check grip width, elbow angle, foot pressure)
...
├─ 10 🍗 Lying Quad Stretch (Prone) (coached, check form before adding load)
...
├─ 12 🍗 Lying Leg Curl (high rep, low load, neural memory)
