...
## Hypertrophy Aesthetic — Plus focus (Mindful) · 55-70 min
...
├─ 12 ➕ Single-Arm Plank (full range, different angle)
...
├─ 12 ➕ Single-Arm Single-Leg Plank (parasympathetic, tension down, 4s eccentric)
│  Set 1: 🦋 50% × 12 (deload)
Rest: 120s
═══
## 5) 🧬 Imprint
Subcode: 🦋🌹➕⚪ (Imprint | Plus | Aesthetic | Mindful)
├─ 12 ➕ Single-Leg Lowering (high rep, low load, neural memory)
