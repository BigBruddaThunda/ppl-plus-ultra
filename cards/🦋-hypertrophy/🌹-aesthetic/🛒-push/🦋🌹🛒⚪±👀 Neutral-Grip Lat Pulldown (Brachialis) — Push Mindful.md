...
blocks: ♨️ ▶️ 🧈 🗿 🪞/🧩 🪫 🚂
---
# 🛒 Medicine Ball Chest Pass — Push Mindful 🛒

## Hypertrophy Aesthetic — Push focus (Mindful) · 55-70 min

**CODE:** 🦋🌹🛒⚪

> "Slow eccentrics under moderate load. Time under tension is the stimulus."

*Aesthetic Specialization: Time under tension protocol — slow eccentrics build tissue that fast reps miss*
═══
## 1) ♨️ Warm-Up — 👀 specio
...
├─ 12 🛒 Single-Arm Cable Chest Fly (parasympathetic, tension down, 4s eccentric)
│  Set 1: 🦋 50% × 12 (deload)
Rest: 120s
═══
## 5) 🧬 Imprint
