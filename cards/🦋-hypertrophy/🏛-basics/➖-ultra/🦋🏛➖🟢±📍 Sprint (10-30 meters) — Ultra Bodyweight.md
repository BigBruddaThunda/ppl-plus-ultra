...
## Hypertrophy Basics — Ultra focus (Bodyweight) · 55-70 min
...
├─ 12 ➖ Rowing Machine (Steady State) (bodyweight, no external load needed)
│  Set 1: 🦋 50% × 12 (pattern prep)
Rest: 60s
═══
## 2) ▶️ Primer
Subcode: 🦋🏛➖🟢 (Primer | Ultra | Basics | Bodyweight)
├─ 10 ➖ Rowing Intervals (500m) (tight setup, crisp intent)
...
═══
## 4) 🗿 Sculpt
Subcode: 🦋🏛➖🟢 (Sculpt | Ultra | Basics | Bodyweight)
├─ 12 ➖ Rowing Intervals (1000m) (angles, tension, volume)
│  Set 1: 🦋 65% × 12 (shaping)
│  Set 2: 🦋 65% × 12 (carving)
Rest: 60s
═══
...
├─ 12 ➖ Rowing Intervals (1000m) (full range, different angle)
...
├─ 12 ➖ Rowing Intervals (2000m) (smooth tempo, downshift)
│  Set 1: 🦋 50% × 12 (deload)
Rest: 60s
═══
## 7) 🚂 Junction
