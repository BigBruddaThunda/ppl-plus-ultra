...
## Hypertrophy Basics — Push focus (Bodyweight) · 55-70 min
...
═══
## 2) ▶️ Primer
Subcode: 🦋🏛🛒🟢 (Primer | Push | Basics | Bodyweight)
...
├─ 10 🛒 Plyometric Push-Up (Hands Leave Ground) (bodyweight, no external load needed)
...
═══
## 4) 🗿 Sculpt
Subcode: 🦋🏛🛒🟢 (Sculpt | Push | Basics | Bodyweight)
