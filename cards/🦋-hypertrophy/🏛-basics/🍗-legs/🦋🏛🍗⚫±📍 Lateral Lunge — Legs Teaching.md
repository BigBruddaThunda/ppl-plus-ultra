...
├─ 10 🍗 Back Squat (High Bar) (coach: check grip width, elbow angle, foot pressure)
...
├─ 10 🍗 Lateral Lunge (coached, check form before adding load)
...
├─ 12 🍗 Conventional Deadlift (high rep, low load, neural memory)
