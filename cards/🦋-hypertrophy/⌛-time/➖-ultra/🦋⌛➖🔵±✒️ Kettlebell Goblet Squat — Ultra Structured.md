...
## Hypertrophy Time — Ultra focus (Structured) · 55-70 min
...
├─ 12 ➖ Turkish Get-Up (Full) (prescribed, track sets and reps)
│  Set 1: 🦋 50% × 12 (pattern prep)
Rest: 60s
═══
## 2) ▶️ Primer
Subcode: 🦋⌛➖🔵 (Primer | Ultra | Time | Structured)
...
├─ 10 ➖ Kettlebell Goblet Squat (prescribed, track sets and reps)
...
═══
## 4) 🗿 Sculpt
Subcode: 🦋⌛➖🔵 (Sculpt | Ultra | Time | Structured)
