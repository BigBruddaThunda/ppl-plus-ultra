...
## Hypertrophy Time — Legs focus (Teaching) · 55-70 min
...
═══
## 1) ♨️ Warm-Up — 🐋 duco
Subcode: 🦋⌛🍗⚫ (Warm-Up | Legs | Time | Teaching)
├─ 12 🍗 Box Jump (Calf Power) (coached, check form before adding load)
│  Set 1: 🦋 50% × 12 (pattern prep)
Rest: 90s
═══
## 2) 🛠 Craft
Subcode: 🦋⌛🍗⚫ (Craft | Legs | Time | Teaching)
├─ 10 🍗 Depth Drop (Reactive Calf) (coach: check grip width, elbow angle, foot pressure)
│  Set 1: 🦋 50% × 10 (practice the pattern, not the load)
│  Set 2: 🦋 55% × 10 (same cues, slightly heavier)
Rest: 112s
═══
## 3) 🧈 Bread & Butter
Subcode: 🦋⌛🍗⚫ (Bread & Butter | Legs | Time | Teaching)
├─ 10 🍗 Single-Leg Jump Rope (coached, check form before adding load)
...
═══
## 4) 🧩 Supplemental
Subcode: 🦋⌛🍗⚫ (Supplemental | Legs | Time | Teaching)
...
═══
## 5) 🧬 Imprint
Subcode: 🦋⌛🍗⚫ (Imprint | Legs | Time | Teaching)
├─ 12 🍗 Farmer's Walk on Toes (high rep, low load, neural memory)
