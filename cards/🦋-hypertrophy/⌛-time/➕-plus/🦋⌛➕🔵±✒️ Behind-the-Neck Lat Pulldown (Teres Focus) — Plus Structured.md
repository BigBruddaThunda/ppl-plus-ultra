...
## Hypertrophy Time — Plus focus (Structured) · 55-70 min
...
├─ 12 ➕ Kettlebell Swing (Two-Hand) (prescribed, track sets and reps)
│  Set 1: 🦋 50% × 12 (pattern prep)
Rest: 60s
═══
## 2) ▶️ Primer
Subcode: 🦋⌛➕🔵 (Primer | Plus | Time | Structured)
├─ 10 ➕ American Swing (Overhead) (tight setup, crisp intent)
...
═══
## 4) 🗿 Sculpt
Subcode: 🦋⌛➕🔵 (Sculpt | Plus | Time | Structured)
├─ 12 ➕ Heavy Swing (Power Focus) (angles, tension, volume)
│  Set 1: 🦋 65% × 12 (shaping)
│  Set 2: 🦋 65% × 12 (carving)
Rest: 60s
═══
...
├─ 12 ➕ Dead Stop Swing (Reset Between Reps) (smooth tempo, downshift)
│  Set 1: 🦋 50% × 12 (deload)
Rest: 60s
═══
## 7) 🚂 Junction
