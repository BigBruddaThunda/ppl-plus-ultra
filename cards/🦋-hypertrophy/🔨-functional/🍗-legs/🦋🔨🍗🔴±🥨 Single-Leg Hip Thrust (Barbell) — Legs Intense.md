...
## Hypertrophy Functional — Legs focus (Intense) · 55-70 min
...
├─ 10 🍗 Single-Leg Hip Thrust (Barbell) (tight setup, crisp intent)
...
├─ 12 🍗 Single-Leg Hip Thrust (Bodyweight) (full range, different angle)
...
├─ 12 🍗 Single-Leg Glute Bridge (all-out, leave nothing in reserve)
...
├─ 12 🍗 Single-Leg Glute Bridge (stress out, cathartic discharge)
│  Set 1: 🦋 50% × 12 (deload)
Rest: 30s
═══
## 7) 🚂 Junction
