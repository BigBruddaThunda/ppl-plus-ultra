...
## Hypertrophy Functional — Legs focus (Teaching) · 55-70 min
...
├─ 12 🍗 Single-Leg Balance Hold (coached, check form before adding load)
│  Set 1: 🦋 50% × 12 (pattern prep)
Rest: 90s
═══
## 2) 🛠 Craft
Subcode: 🦋🔨🍗⚫ (Craft | Legs | Functional | Teaching)
├─ 10 🍗 Single-Leg Balance with Perturbation (coach: check grip width, elbow angle, foot pressure)
...
├─ 12 🍗 Single-Leg Reach (Multi-Directional) (high rep, low load, neural memory)
