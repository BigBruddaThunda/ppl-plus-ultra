...
## Hypertrophy Functional — Pull focus (Teaching) · 55-70 min
...
═══
## 2) ▶️ Primer
Subcode: 🦋🔨🪡⚫ (Primer | Pull | Functional | Teaching)
...
═══
## 4) 🗿 Sculpt
Subcode: 🦋🔨🪡⚫ (Sculpt | Pull | Functional | Teaching)
...
═══
## 6) 🪫 Release
Subcode: 🦋🔨🪡⚫ (Release | Pull | Functional | Teaching)
