...
blocks: ♨️ ▶️ 🧈 🗿 🪞/🧩 🪫 🚂
---
# ➕ Single-Arm Face Pull — Plus Fun ➕

## Hypertrophy Functional — Plus focus (Fun) · 55-70 min
...
├─ 10 ➕ Good Morning (Barbell) (try the unfamiliar version, explore the range)
│  Set 1: 🦋 55% × 10 (discovery set)
Rest: 60s
═══
## 4) 🏖 Sandbox
Subcode: 🦋🔨➕🟡 (Sandbox | Plus | Functional | Fun)
├─ 10 ➕ Single-Arm Face Pull (explore within constraints, choose your variation)
