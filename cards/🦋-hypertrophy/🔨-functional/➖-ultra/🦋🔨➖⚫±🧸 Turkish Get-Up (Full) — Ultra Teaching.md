...
## Hypertrophy Functional — Ultra focus (Teaching) · 55-70 min
...
├─ 12 ➖ Kettlebell Goblet Squat (coached, check form before adding load)
│  Set 1: 🦋 50% × 12 (pattern prep)
Rest: 90s
═══
## 2) 🛠 Craft
Subcode: 🦋🔨➖⚫ (Craft | Ultra | Functional | Teaching)
├─ 10 ➖ Turkish Get-Up (Full) (coach: check grip width, elbow angle, foot pressure)
