...
## Full Body Aesthetic — Ultra focus (Intense) · 40-55 min
...
├─ 10 ➖ Sprint (10-30 meters) (high effort, push the pace)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 30s
═══
## 2) ▶️ Primer
Subcode: 🌾🌹➖🔴 (Primer | Ultra | Aesthetic | Intense)
├─ 9 ➖ Sprint (30-60 meters) (tight setup, crisp intent)
│  Set 1: 🌾 60% × 9 (activation)
Rest: 30s
═══
## 3) 🧈 Bread & Butter
Subcode: 🌾🌹➖🔴 (Bread & Butter | Ultra | Aesthetic | Intense)
├─ 9 ➖ Single-Leg Hops Through Ladder (high effort, push the pace)
...
├─ 10 ➖ Hill Sprint (Short) (all-out, leave nothing in reserve)
...
├─ 10 ➖ Hill Sprint (Short) (stress out, cathartic discharge)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 30s
═══
## 7) 🚂 Junction
