...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# 🛒 Neutral-Grip Lat Pulldown (Brachialis) — Push Mindful 🛒
...
├─ 9 🛒 Neutral-Grip Lat Pulldown (Brachialis) (4s eccentric, breath-paced)
...
├─ 10 🛒 Band Pull-Apart (Chest Opener) (full range, different angle)
...
├─ 10 🛒 Preacher Curl Machine (parasympathetic, tension down, 4s eccentric)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 120s
═══
## 5) 🧬 Imprint
