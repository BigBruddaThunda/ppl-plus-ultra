...
├─ 10 🛒 Single-Arm Cable Chest Fly (high effort, push the pace)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 60s
═══
## 2) 🎼 Composition
Subcode: 🌾🌹🛒🔴 (Composition | Push | Aesthetic | Intense)
├─ 9 🛒 Medicine Ball Chest Pass → Alternating Hammer Curl (flow without reset)
...
├─ 9 🛒 Alternating Hammer Curl (high effort, push the pace)
...
├─ 11 🛒 Alternating Dumbbell Front Raise (full range, different angle)
...
├─ 12 🛒 Alternating Dumbbell Curl (stress out, cathartic discharge)
│  Set 1: 🌾 50% × 12 (deload)
Rest: 45s
═══
## 6) 🚂 Junction
