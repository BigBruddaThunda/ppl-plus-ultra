...
## Full Body Aesthetic — Pull focus (Fun) · 40-55 min
...
├─ 9 🪡 Half-Kneeling Band Single-Arm Pulldown (try the unfamiliar version, explore the range)
│  Set 1: 🌾 55% × 9 (discovery set)
Rest: 45s
═══
## 4) 🏖 Sandbox
Subcode: 🌾🌹🪡🟡 (Sandbox | Pull | Aesthetic | Fun)
├─ 9 🪡 One-Arm Dead Hang (explore within constraints, choose your variation)
