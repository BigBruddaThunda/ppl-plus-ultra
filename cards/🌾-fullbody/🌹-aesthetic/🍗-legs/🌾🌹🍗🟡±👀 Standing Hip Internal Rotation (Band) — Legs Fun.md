...
## Full Body Aesthetic — Legs focus (Fun) · 40-55 min
...
├─ 10 🍗 Half-Kneeling Hip Flexor Stretch (explore, stay within constraints)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 60s
═══
## 2) 🎼 Composition
Subcode: 🌾🌹🍗🟡 (Composition | Legs | Aesthetic | Fun)
├─ 9 🍗 Single-Leg Extension → Standing Hip Internal Rotation (Band) (flow without reset)
...
├─ 9 🍗 Standing Hip Internal Rotation (Band) (explore, stay within constraints)
...
═══
## 4) 🧩 Supplemental
Subcode: 🌾🌹🍗🟡 (Supplemental | Legs | Aesthetic | Fun)
