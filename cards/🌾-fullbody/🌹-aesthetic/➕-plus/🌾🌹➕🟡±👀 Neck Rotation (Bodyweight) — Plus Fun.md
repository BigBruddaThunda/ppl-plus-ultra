...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# ➕ Neck Rotation (Bodyweight) — Plus Fun ➕

## Full Body Aesthetic — Plus focus (Fun) · 40-55 min
...
├─ 10 ➕ Aquaman (Alternating Superman) (explore, stay within constraints)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 60s
═══
## 2) 🧈 Bread & Butter
Subcode: 🌾🌹➕🟡 (Bread & Butter | Plus | Aesthetic | Fun)
├─ 9 ➕ Neck Rotation (Bodyweight) (explore, stay within constraints)
...
├─ 9 ➕ Single-Leg Hops Through Ladder (try the unfamiliar version, explore the range)
│  Set 1: 🌾 55% × 9 (discovery set)
Rest: 45s
═══
## 4) 🏖 Sandbox
Subcode: 🌾🌹➕🟡 (Sandbox | Plus | Aesthetic | Fun)
├─ 9 ➕ Neck Rotation (Bodyweight) (explore within constraints, choose your variation)
...
├─ 10 ➕ Single-Leg Hops Through Ladder (smooth tempo, downshift)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 45s
═══
## 6) 🚂 Junction
