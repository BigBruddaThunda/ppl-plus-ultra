...
## Full Body Aesthetic — Plus focus (Teaching) · 40-55 min
...
═══
## 1) ♨️ Warm-Up — 👀 specio
Subcode: 🌾🌹➕⚫ (Warm-Up | Plus | Aesthetic | Teaching)
├─ 10 ➕ Walking High Knees (coached, check form before adding load)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 90s
═══
## 2) 🛠 Craft
Subcode: 🌾🌹➕⚫ (Craft | Plus | Aesthetic | Teaching)
├─ 9 ➕ Walking Butt Kicks (coach: check grip width, elbow angle, foot pressure)
...
├─ 9 ➕ Hip Flexor Stretch (Half-Kneeling) (coached, check form before adding load)
...
═══
## 4) 🧩 Supplemental
Subcode: 🌾🌹➕⚫ (Supplemental | Plus | Aesthetic | Teaching)
├─ 10 ➕ Walking Leg Cradle (full range, different angle)
...
├─ 10 ➕ Inchworm Walkout (high rep, low load, neural memory)
