...
## Full Body Partner — Legs focus (Technical) · 40-55 min
...
├─ 10 🍗 Half-Kneeling Hip Flexor Stretch (precision, quality over volume)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 90s
═══
## 2) ▶️ Primer
Subcode: 🌾🐬🍗🟣 (Primer | Legs | Partner | Technical)
├─ 9 🍗 Single-Leg Pogo Hops (tight setup, crisp intent)
│  Set 1: 🌾 60% × 9 (activation)
Rest: 90s
═══
## 3) 🧈 Bread & Butter
Subcode: 🌾🐬🍗🟣 (Bread & Butter | Legs | Partner | Technical)
├─ 9 🍗 Single-Leg Jump Rope (precision, quality over volume)
