...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# 🪡 Single-Leg Hip Thrust (Bodyweight) — Pull Intense 🪡

## Full Body Partner — Pull focus (Intense) · 40-55 min
...
├─ 10 🪡 Single-Arm Face Pull (high effort, push the pace)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 30s
═══
## 2) ▶️ Primer
Subcode: 🌾🐬🪡🔴 (Primer | Pull | Partner | Intense)
├─ 9 🪡 Aquaman (Alternating Superman) (tight setup, crisp intent)
│  Set 1: 🌾 60% × 9 (activation)
Rest: 30s
═══
## 3) 🧈 Bread & Butter
Subcode: 🌾🐬🪡🔴 (Bread & Butter | Pull | Partner | Intense)
├─ 9 🪡 Single-Leg Hip Thrust (Bodyweight) (high effort, push the pace)
...
├─ 10 🪡 Single-Leg Hip Thrust (Barbell) (full range, different angle)
...
├─ 10 🪡 Alternating Dumbbell Front Raise (all-out, leave nothing in reserve)
...
├─ 10 🪡 Alternating Dumbbell Front Raise (stress out, cathartic discharge)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 30s
═══
## 7) 🚂 Junction
