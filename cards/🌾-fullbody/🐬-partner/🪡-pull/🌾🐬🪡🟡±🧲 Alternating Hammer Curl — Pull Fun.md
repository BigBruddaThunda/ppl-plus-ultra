...
## Full Body Partner — Pull focus (Fun) · 40-55 min
...
═══
## 2) 🎼 Composition
Subcode: 🌾🐬🪡🟡 (Composition | Pull | Partner | Fun)
├─ 9 🪡 Aquaman (Alternating Superman) → Alternating Hammer Curl (flow without reset)
...
├─ 11 🪡 Single-Leg Romanian Deadlift (full range, different angle)
