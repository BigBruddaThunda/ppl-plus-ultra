...
═══
## 2) 🎼 Composition
Subcode: 🌾🐬➖🟠 (Composition | Ultra | Partner | Circuit)
├─ 9 ➖ Single-Leg Jump Rope → Kettlebell Swing (Single-Arm) (flow without reset)
...
│  Station 3: ➖ Single-Leg Jump Rope × 9 (station rotation, keep moving)
