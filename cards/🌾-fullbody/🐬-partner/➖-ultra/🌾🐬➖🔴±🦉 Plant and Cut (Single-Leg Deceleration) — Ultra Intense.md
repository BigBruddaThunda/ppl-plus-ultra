...
├─ 9 ➖ Partner Toss (Alternating) (tight setup, crisp intent)
...
├─ 10 ➖ Single-Foot In Each Box (Forward) (all-out, leave nothing in reserve)
...
├─ 10 ➖ Single-Foot In Each Box (Forward) (stress out, cathartic discharge)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 30s
═══
## 7) 🚂 Junction
