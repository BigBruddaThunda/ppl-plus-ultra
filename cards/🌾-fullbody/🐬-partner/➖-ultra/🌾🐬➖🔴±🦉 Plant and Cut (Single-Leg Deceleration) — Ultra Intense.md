...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# ➖ Plant and Cut (Single-Leg Deceleration) — Ultra Intense ➖

## Full Body Partner — Ultra focus (Intense) · 40-55 min
...
═══
## 2) 🎼 Composition
Subcode: 🌾🐬➖🔴 (Composition | Ultra | Partner | Intense)
├─ 9 ➖ Partner Toss (Alternating) → Plant and Cut (Single-Leg Deceleration) (flow without reset)
...
├─ 9 ➖ Plant and Cut (Single-Leg Deceleration) (high effort, push the pace)
...
├─ 12 ➖ Single-Foot In Each Box (Forward) (stress out, cathartic discharge)
│  Set 1: 🌾 50% × 12 (deload)
Rest: 45s
═══
## 6) 🚂 Junction
