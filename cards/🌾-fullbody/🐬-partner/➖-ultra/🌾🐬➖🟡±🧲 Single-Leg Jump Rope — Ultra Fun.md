...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# ➖ Single-Leg Jump Rope — Ultra Fun ➖

## Full Body Partner — Ultra focus (Fun) · 40-55 min
...
═══
## 2) 🎼 Composition
Subcode: 🌾🐬➖🟡 (Composition | Ultra | Partner | Fun)
├─ 9 ➖ Single-Leg Jump Rope → Single-Leg Jump Rope (flow without reset)
...
═══
## 5) 🪫 Release
Subcode: 🌾🐬➖🟡 (Release | Ultra | Partner | Fun)
