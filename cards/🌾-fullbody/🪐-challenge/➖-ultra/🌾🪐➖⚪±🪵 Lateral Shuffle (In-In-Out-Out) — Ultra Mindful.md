...
## Full Body Challenge — Ultra focus (Mindful) · 40-55 min

**CODE:** 🌾🪐➖⚪

> "Breathe through the full chain. Each movement flows into the next."

*Explorer / Outdoor Athlete: Recovery within the discipline — slow, mindful practice of the core positions*
═══
## 1) ♨️ Warm-Up — 🪵 teneo
Subcode: 🌾🪐➖⚪ (Warm-Up | Ultra | Challenge | Mindful)
├─ 10 ➖ Kettlebell Swing (Single-Arm) (4s eccentric, breath-paced)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 120s
═══
## 2) 🧈 Bread & Butter
Subcode: 🌾🪐➖⚪ (Bread & Butter | Ultra | Challenge | Mindful)
├─ 9 ➖ Single-Leg Hops Through Ladder (4s eccentric, breath-paced)
...
├─ 10 ➖ Single-Arm American Swing (4s eccentric, breath-paced)
...
├─ 10 ➖ Single-Leg Swing (parasympathetic, tension down, 4s eccentric)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 120s
═══
## 5) 🧬 Imprint
Subcode: 🌾🪐➖⚪ (Imprint | Ultra | Challenge | Mindful)
├─ 10 ➖ Alternating Kettlebell Snatch (4s eccentric, breath-paced)
