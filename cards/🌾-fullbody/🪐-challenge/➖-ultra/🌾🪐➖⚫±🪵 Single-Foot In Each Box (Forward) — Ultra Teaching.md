...
## Full Body Challenge — Ultra focus (Teaching) · 40-55 min
...
═══
## 2) 🎼 Composition
Subcode: 🌾🪐➖⚫ (Composition | Ultra | Challenge | Teaching)
├─ 9 ➖ Partner Toss (Alternating) → Single-Foot In Each Box (Forward) (flow without reset)
