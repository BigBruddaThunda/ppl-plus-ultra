...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# ➖ Two Feet In Each Box (Forward) — Ultra Circuit ➖

## Full Body Challenge — Ultra focus (Circuit) · 40-55 min
...
═══
## 2) 🎼 Composition
Subcode: 🌾🪐➖🟠 (Composition | Ultra | Challenge | Circuit)
├─ 9 ➖ Partner Toss (Alternating) → Two Feet In Each Box (Forward) (flow without reset)
...
│  Station 1: ➖ Two Feet In Each Box (Forward) × 9 (station rotation, keep moving)
│  Station 2: ➖ Single-Leg Hops Through Ladder × 9 (station rotation, keep moving)
│  Station 3: ➖ Partner Toss (Alternating) × 9 (station rotation, keep moving)
