...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# 🍗 Single-Leg Hip Thrust (Barbell) — Legs Bodyweight 🍗

## Full Body Challenge — Legs focus (Bodyweight) · 40-55 min
...
├─ 10 🍗 Single-Leg Hip Thrust (Bodyweight) (bodyweight, no external load needed)
...
├─ 10 🍗 Single-Leg Balance with Perturbation (smooth tempo, downshift)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 45s
═══
## 6) 🚂 Junction
