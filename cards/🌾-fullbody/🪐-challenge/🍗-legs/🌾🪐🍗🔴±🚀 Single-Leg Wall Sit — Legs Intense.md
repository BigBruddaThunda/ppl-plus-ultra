...
## Full Body Challenge — Legs focus (Intense) · 40-55 min
...
├─ 10 🍗 Single-Leg Hip Thrust (Bodyweight) (high effort, push the pace)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 30s
═══
## 2) ▶️ Primer
Subcode: 🌾🪐🍗🔴 (Primer | Legs | Challenge | Intense)
├─ 9 🍗 Single-Leg Glute Bridge (tight setup, crisp intent)
│  Set 1: 🌾 60% × 9 (activation)
Rest: 30s
═══
## 3) 🧈 Bread & Butter
Subcode: 🌾🪐🍗🔴 (Bread & Butter | Legs | Challenge | Intense)
├─ 9 🍗 Single-Leg Hip Thrust (Barbell) (high effort, push the pace)
...
├─ 10 🍗 Single-Leg Balance Hold (full range, different angle)
...
├─ 10 🍗 Single-Leg Balance with Perturbation (all-out, leave nothing in reserve)
...
├─ 10 🍗 Single-Leg Balance with Perturbation (stress out, cathartic discharge)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 30s
═══
## 7) 🚂 Junction
