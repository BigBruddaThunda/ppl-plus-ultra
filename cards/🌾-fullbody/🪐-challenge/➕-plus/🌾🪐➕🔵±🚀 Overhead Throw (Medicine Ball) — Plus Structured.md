...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# ➕ Overhead Throw (Medicine Ball) — Plus Structured ➕

## Full Body Challenge — Plus focus (Structured) · 40-55 min
...
├─ 10 ➕ Shot Put Throw (Single-Arm) (prescribed, track sets and reps)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 60s
═══
## 2) 🎼 Composition
Subcode: 🌾🪐➕🔵 (Composition | Plus | Challenge | Structured)
├─ 9 ➕ Archer Pull-Up → Overhead Throw (Medicine Ball) (flow without reset)
...
├─ 9 ➕ Overhead Throw (Medicine Ball) (prescribed, track sets and reps)
...
├─ 11 ➕ Single-Arm Dumbbell Row (full range, different angle)
