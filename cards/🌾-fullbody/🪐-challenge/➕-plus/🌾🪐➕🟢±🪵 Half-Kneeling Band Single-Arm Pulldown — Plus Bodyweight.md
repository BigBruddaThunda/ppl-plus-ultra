...
## Full Body Challenge — Plus focus (Bodyweight) · 40-55 min
...
═══
## 2) 🎼 Composition
Subcode: 🌾🪐➕🟢 (Composition | Plus | Challenge | Bodyweight)
├─ 9 ➕ Single-Leg Hops Through Ladder → Half-Kneeling Band Single-Arm Pulldown (flow without reset)
