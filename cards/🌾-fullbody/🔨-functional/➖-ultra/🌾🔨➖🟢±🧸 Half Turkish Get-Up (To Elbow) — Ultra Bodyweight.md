...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# ➖ Half Turkish Get-Up (To Elbow) — Ultra Bodyweight ➖

## Full Body Functional — Ultra focus (Bodyweight) · 40-55 min
...
═══
## 2) 🎼 Composition
Subcode: 🌾🔨➖🟢 (Composition | Ultra | Functional | Bodyweight)
├─ 9 ➖ Turkish Get-Up (Full) → Half Turkish Get-Up (To Elbow) (flow without reset)
...
├─ 9 ➖ Half Turkish Get-Up (To Elbow) (bodyweight, no external load needed)
