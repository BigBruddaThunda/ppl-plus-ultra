...
## Full Body Functional — Pull focus (Fun) · 40-55 min
...
├─ 9 🪡 Single-Arm Lat Pulldown (try the unfamiliar version, explore the range)
│  Set 1: 🌾 55% × 9 (discovery set)
Rest: 45s
═══
## 4) 🏖 Sandbox
Subcode: 🌾🔨🪡🟡 (Sandbox | Pull | Functional | Fun)
├─ 9 🪡 Single-Arm Dumbbell Row (explore within constraints, choose your variation)
...
├─ 10 🪡 Single-Arm Lat Pulldown (smooth tempo, downshift)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 45s
═══
## 6) 🚂 Junction
