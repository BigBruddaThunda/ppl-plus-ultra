...
## Full Body Functional — Legs focus (Teaching) · 40-55 min
...
═══
## 2) 🎼 Composition
Subcode: 🌾🔨🍗⚫ (Composition | Legs | Functional | Teaching)
├─ 9 🍗 Single-Leg Extension → Kettlebell Swing (Alternating Arms) (flow without reset)
...
├─ 11 🍗 Single-Leg Good Morning (full range, different angle)
│  Set 1: 🌾 60% × 11 (support volume)
│  Set 2: 🌾 60% × 11 (non-redundant)
Rest: 45s
═══
## 5) 🪫 Release
Subcode: 🌾🔨🍗⚫ (Release | Legs | Functional | Teaching)
