...
## Full Body Functional — Legs focus (Bodyweight) · 40-55 min
...
═══
## 2) 🎼 Composition
Subcode: 🌾🔨🍗🟢 (Composition | Legs | Functional | Bodyweight)
├─ 9 🍗 Single-Leg Extension → Single-Leg Toe Raise (flow without reset)
│  Set 1: 🌾 70% × 9 (unified pattern)
│  Set 2: 🌾 70% × 9 (repeat flow)
Rest: 60s
═══
## 3) 🧈 Bread & Butter
Subcode: 🌾🔨🍗🟢 (Bread & Butter | Legs | Functional | Bodyweight)
├─ 9 🍗 Single-Leg Toe Raise (bodyweight, no external load needed)
...
═══
## 4) 🧩 Supplemental
Subcode: 🌾🔨🍗🟢 (Supplemental | Legs | Functional | Bodyweight)
...
═══
## 5) 🪫 Release
Subcode: 🌾🔨🍗🟢 (Release | Legs | Functional | Bodyweight)
