...
## Full Body Functional — Push focus (Bodyweight) · 40-55 min
...
├─ 10 🛒 Single-Arm Dumbbell Lateral Raise (bodyweight, no external load needed)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 60s
═══
## 2) 🎼 Composition
Subcode: 🌾🔨🛒🟢 (Composition | Push | Functional | Bodyweight)
├─ 9 🛒 Single-Arm Cable Rear Delt Fly → Alternating Dumbbell Front Raise (flow without reset)
...
├─ 9 🛒 Alternating Dumbbell Front Raise (bodyweight, no external load needed)
...
├─ 10 🛒 Single-Arm Overhead Dumbbell Hold (full range, different angle)
│  Set 1: 🌾 60% × 10 (support volume)
│  Set 2: 🌾 60% × 10 (non-redundant)
Rest: 45s
═══
## 5) 🪫 Release
Subcode: 🌾🔨🛒🟢 (Release | Push | Functional | Bodyweight)
├─ 10 🛒 Single-Arm Cable Chest Fly (smooth tempo, downshift)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 45s
═══
## 6) 🚂 Junction
