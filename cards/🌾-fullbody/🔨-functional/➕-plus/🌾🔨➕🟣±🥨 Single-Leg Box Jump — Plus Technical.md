...
## Full Body Functional — Plus focus (Technical) · 40-55 min
...
═══
## 2) 🎼 Composition
Subcode: 🌾🔨➕🟣 (Composition | Plus | Functional | Technical)
├─ 9 ➕ Sandbag Shouldering (Alternating) → Single-Leg Box Jump (flow without reset)
...
├─ 9 ➕ Single-Leg Box Jump (precision, quality over volume)
