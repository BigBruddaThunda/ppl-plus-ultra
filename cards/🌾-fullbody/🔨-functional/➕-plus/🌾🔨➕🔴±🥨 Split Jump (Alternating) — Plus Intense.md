...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# ➕ Split Jump (Alternating) — Plus Intense ➕

## Full Body Functional — Plus focus (Intense) · 40-55 min
...
═══
## 2) 🎼 Composition
Subcode: 🌾🔨➕🔴 (Composition | Plus | Functional | Intense)
├─ 9 ➕ Sandbag Shouldering (Alternating) → Split Jump (Alternating) (flow without reset)
...
├─ 9 ➕ Split Jump (Alternating) (high effort, push the pace)
...
├─ 12 ➕ Sandbag Good Morning (stress out, cathartic discharge)
│  Set 1: 🌾 50% × 12 (deload)
Rest: 45s
═══
## 6) 🚂 Junction
