...
├─ 10 ➕ Leg Swings (Forward/Backward) (coached, check form before adding load)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 90s
═══
## 2) 🛠 Craft
Subcode: 🌾🔨➕⚫ (Craft | Plus | Functional | Teaching)
├─ 9 ➕ Leg Swings (Lateral/Side-to-Side) (coach: check grip width, elbow angle, foot pressure)
