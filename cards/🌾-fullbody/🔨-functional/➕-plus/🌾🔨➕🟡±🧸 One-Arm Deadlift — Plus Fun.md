...
## Full Body Functional — Plus focus (Fun) · 40-55 min
...
├─ 10 ➕ Half-Kneeling Band Single-Arm Pulldown (explore, stay within constraints)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 60s
═══
## 2) 🧈 Bread & Butter
Subcode: 🌾🔨➕🟡 (Bread & Butter | Plus | Functional | Fun)
├─ 9 ➕ Aquaman (Alternating Superman) (explore, stay within constraints)
...
├─ 9 ➕ Single-Arm Single-Leg Plank (try the unfamiliar version, explore the range)
│  Set 1: 🌾 55% × 9 (discovery set)
Rest: 45s
═══
## 4) 🏖 Sandbox
Subcode: 🌾🔨➕🟡 (Sandbox | Plus | Functional | Fun)
├─ 9 ➕ Single-Leg Lowering (explore within constraints, choose your variation)
...
├─ 10 ➕ Single-Arm Single-Leg Plank (smooth tempo, downshift)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 45s
═══
## 6) 🚂 Junction
