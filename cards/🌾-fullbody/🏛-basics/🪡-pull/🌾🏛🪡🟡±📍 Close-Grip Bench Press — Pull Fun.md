...
├─ 10 🪡 Wide-Grip Pull-Up (Teres Focus) (explore, stay within constraints)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 60s
═══
## 2) 🎼 Composition
Subcode: 🌾🏛🪡🟡 (Composition | Pull | Basics | Fun)
├─ 9 🪡 Chest-Supported Row (Elbow Out) → Close-Grip Bench Press (flow without reset)
...
├─ 9 🪡 Close-Grip Bench Press (explore, stay within constraints)
