...
## Full Body Basics — Pull focus (Fun) · 40-55 min
...
├─ 9 🪡 Single-Arm Face Pull (explore, stay within constraints)
...
├─ 9 🪡 Straight-Arm Pulldown (Bar) (try the unfamiliar version, explore the range)
│  Set 1: 🌾 55% × 9 (discovery set)
Rest: 45s
═══
## 4) 🏖 Sandbox
Subcode: 🌾🏛🪡🟡 (Sandbox | Pull | Basics | Fun)
├─ 9 🪡 Straight-Arm Pulldown (Rope) (explore within constraints, choose your variation)
...
├─ 10 🪡 Straight-Arm Pulldown (Bar) (smooth tempo, downshift)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 45s
═══
## 6) 🚂 Junction
