...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# 🪡 Chin-Up (Underhand Grip) — Pull Intense 🪡

## Full Body Basics — Pull focus (Intense) · 40-55 min
...
├─ 10 🪡 Zercher Carry (high effort, push the pace)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 30s
═══
## 2) ▶️ Primer
Subcode: 🌾🏛🪡🔴 (Primer | Pull | Basics | Intense)
├─ 9 🪡 Pull-Up (Overhand Grip) (tight setup, crisp intent)
│  Set 1: 🌾 60% × 9 (activation)
Rest: 30s
═══
## 3) 🧈 Bread & Butter
Subcode: 🌾🏛🪡🔴 (Bread & Butter | Pull | Basics | Intense)
├─ 9 🪡 Chin-Up (Underhand Grip) (high effort, push the pace)
...
├─ 10 🪡 Bent-Over Barbell Row (Overhand) (full range, different angle)
│  Set 1: 🌾 60% × 10 (support volume)
│  Set 2: 🌾 60% × 10 (non-redundant)
Rest: 30s
═══
## 5) 🌋 Gutter
Subcode: 🌾🏛🪡🔴 (Gutter | Pull | Basics | Intense)
├─ 10 🪡 Push Jerk (Barbell) (all-out, leave nothing in reserve)
│  Set 1: 🌾 55% × 10 (push to form break)
│  Set 2: 🌾 55% × AMRAP (final effort)
Rest: 45s
═══
## 6) 🪫 Release
Subcode: 🌾🏛🪡🔴 (Release | Pull | Basics | Intense)
├─ 10 🪡 Push Jerk (Barbell) (stress out, cathartic discharge)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 30s
═══
## 7) 🚂 Junction
