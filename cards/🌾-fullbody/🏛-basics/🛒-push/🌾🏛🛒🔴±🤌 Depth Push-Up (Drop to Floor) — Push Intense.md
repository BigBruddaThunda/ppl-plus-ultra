...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# 🛒 Depth Push-Up (Drop to Floor) — Push Intense 🛒

## Full Body Basics — Push focus (Intense) · 40-55 min
...
├─ 10 🛒 Plyometric Push-Up (Hands Leave Ground) (high effort, push the pace)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 30s
═══
## 2) ▶️ Primer
Subcode: 🌾🏛🛒🔴 (Primer | Push | Basics | Intense)
├─ 9 🛒 Bamboo Bar Bench Press (tight setup, crisp intent)
│  Set 1: 🌾 60% × 9 (activation)
Rest: 30s
═══
## 3) 🧈 Bread & Butter
Subcode: 🌾🏛🛒🔴 (Bread & Butter | Push | Basics | Intense)
├─ 9 🛒 Depth Push-Up (Drop to Floor) (high effort, push the pace)
...
├─ 10 🛒 Push Jerk (Barbell) (full range, different angle)
...
├─ 10 🛒 Barbell Bench Press (all-out, leave nothing in reserve)
...
├─ 10 🛒 Barbell Bench Press (stress out, cathartic discharge)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 30s
═══
## 7) 🚂 Junction
