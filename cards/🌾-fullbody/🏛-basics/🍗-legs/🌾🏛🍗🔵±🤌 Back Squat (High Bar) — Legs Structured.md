...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# 🍗 Back Squat (High Bar) — Legs Structured 🍗

## Full Body Basics — Legs focus (Structured) · 40-55 min
...
═══
## 2) 🎼 Composition
Subcode: 🌾🏛🍗🔵 (Composition | Legs | Basics | Structured)
├─ 9 🍗 Leg Press Calf Raise → Back Squat (High Bar) (flow without reset)
...
├─ 9 🍗 Back Squat (High Bar) (prescribed, track sets and reps)
...
├─ 11 🍗 Walking Lunge (full range, different angle)
