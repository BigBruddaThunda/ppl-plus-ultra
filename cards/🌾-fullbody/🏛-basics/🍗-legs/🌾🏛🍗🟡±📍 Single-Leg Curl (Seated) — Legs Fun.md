...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# 🍗 Single-Leg Curl (Seated) — Legs Fun 🍗

## Full Body Basics — Legs focus (Fun) · 40-55 min
...
├─ 10 🍗 Deep Squat Hold (Ankle Mobility) (explore, stay within constraints)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 60s
═══
## 2) 🧈 Bread & Butter
Subcode: 🌾🏛🍗🟡 (Bread & Butter | Legs | Basics | Fun)
├─ 9 🍗 Single-Leg Curl (Seated) (explore, stay within constraints)
...
├─ 9 🍗 Spanish Squat (Banded VMO) (try the unfamiliar version, explore the range)
│  Set 1: 🌾 55% × 9 (discovery set)
Rest: 45s
═══
## 4) 🏖 Sandbox
Subcode: 🌾🏛🍗🟡 (Sandbox | Legs | Basics | Fun)
├─ 9 🍗 Conventional Deadlift (explore within constraints, choose your variation)
