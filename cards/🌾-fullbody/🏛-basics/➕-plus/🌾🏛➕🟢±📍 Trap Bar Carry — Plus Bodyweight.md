...
## Full Body Basics — Plus focus (Bodyweight) · 40-55 min
...
├─ 10 ➕ Wide-Grip Pull-Up (Teres Focus) (bodyweight, no external load needed)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 60s
═══
## 2) 🎼 Composition
Subcode: 🌾🏛➕🟢 (Composition | Plus | Basics | Bodyweight)
...
├─ 9 ➕ Trap Bar Carry (bodyweight, no external load needed)
