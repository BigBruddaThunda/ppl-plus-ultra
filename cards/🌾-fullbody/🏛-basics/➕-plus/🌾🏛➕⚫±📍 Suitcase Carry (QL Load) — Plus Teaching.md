...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# ➕ Leg Swings (Forward/Backward) — Plus Teaching ➕

## Full Body Basics — Plus focus (Teaching) · 40-55 min
...
├─ 10 ➕ Leg Swings (Lateral/Side-to-Side) (coached, check form before adding load)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 90s
═══
## 2) 🛠 Craft
Subcode: 🌾🏛➕⚫ (Craft | Plus | Basics | Teaching)
├─ 9 ➕ Walking Lunge with Twist (coach: check grip width, elbow angle, foot pressure)
...
├─ 9 ➕ Leg Swings (Forward/Backward) (coached, check form before adding load)
...
├─ 10 ➕ Spiderman Lunge (full range, different angle)
