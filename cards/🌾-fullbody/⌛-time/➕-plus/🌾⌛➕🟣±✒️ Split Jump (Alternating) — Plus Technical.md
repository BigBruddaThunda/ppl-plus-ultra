...
## Full Body Time — Plus focus (Technical) · 40-55 min
...
├─ 10 ➕ Single-Leg Box Jump (precision, quality over volume)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 60s
═══
## 2) 🎼 Composition
Subcode: 🌾⌛➕🟣 (Composition | Plus | Time | Technical)
├─ 9 ➕ Single-Leg Hops Through Ladder → Split Jump (Alternating) (flow without reset)
...
├─ 11 ➕ Yoke Walk (full range, different angle)
...
├─ 12 ➕ Sandbag Good Morning (smooth tempo, downshift)
│  Set 1: 🌾 50% × 12 (deload)
Rest: 45s
═══
## 6) 🚂 Junction
