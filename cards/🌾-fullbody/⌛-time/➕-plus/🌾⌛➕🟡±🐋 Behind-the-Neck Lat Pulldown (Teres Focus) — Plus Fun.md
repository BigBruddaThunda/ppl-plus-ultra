...
## Full Body Time — Plus focus (Fun) · 40-55 min
...
├─ 10 ➕ American Swing (Overhead) (explore, stay within constraints)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 60s
═══
## 2) 🧈 Bread & Butter
Subcode: 🌾⌛➕🟡 (Bread & Butter | Plus | Time | Fun)
├─ 9 ➕ Kettlebell Swing (Two-Hand) (explore, stay within constraints)
...
├─ 9 ➕ Double Kettlebell Swing (try the unfamiliar version, explore the range)
│  Set 1: 🌾 55% × 9 (discovery set)
Rest: 45s
═══
## 4) 🏖 Sandbox
Subcode: 🌾⌛➕🟡 (Sandbox | Plus | Time | Fun)
├─ 9 ➕ Swing to High Pull (explore within constraints, choose your variation)
