...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# 🍗 Single-Leg Wall Sit — Legs Structured 🍗

## Full Body Time — Legs focus (Structured) · 40-55 min
...
═══
## 2) 🎼 Composition
Subcode: 🌾⌛🍗🔵 (Composition | Legs | Time | Structured)
├─ 9 🍗 Half-Kneeling Hip Flexor Stretch → Single-Leg Wall Sit (flow without reset)
...
├─ 9 🍗 Single-Leg Wall Sit (prescribed, track sets and reps)
