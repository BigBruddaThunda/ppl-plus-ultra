...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# 🍗 Single-Leg Good Morning — Legs Technical 🍗

## Full Body Time — Legs focus (Technical) · 40-55 min
...
├─ 9 🍗 Half-Kneeling Hip Flexor Stretch (tight setup, crisp intent)
│  Set 1: 🌾 60% × 9 (activation)
Rest: 90s
═══
## 3) 🧈 Bread & Butter
Subcode: 🌾⌛🍗🟣 (Bread & Butter | Legs | Time | Technical)
├─ 9 🍗 Single-Leg Good Morning (precision, quality over volume)
