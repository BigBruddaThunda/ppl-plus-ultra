...
═══
## 2) 🎼 Composition
Subcode: 🌾⌛🍗🟡 (Composition | Legs | Time | Fun)
├─ 9 🍗 Half-Kneeling Hip Flexor Stretch → Box Jump (flow without reset)
...
├─ 9 🍗 Box Jump (explore, stay within constraints)
...
═══
## 4) 🧩 Supplemental
Subcode: 🌾⌛🍗🟡 (Supplemental | Legs | Time | Fun)
