...
## Full Body Time — Legs focus (Fun) · 40-55 min
...
├─ 10 🍗 Single-Leg Hip Thrust (Barbell) (explore, stay within constraints)
...
├─ 9 🍗 Single-Leg Balance Hold (try the unfamiliar version, explore the range)
│  Set 1: 🌾 55% × 9 (discovery set)
Rest: 45s
═══
## 4) 🏖 Sandbox
Subcode: 🌾⌛🍗🟡 (Sandbox | Legs | Time | Fun)
├─ 9 🍗 Single-Leg Balance with Perturbation (explore within constraints, choose your variation)
