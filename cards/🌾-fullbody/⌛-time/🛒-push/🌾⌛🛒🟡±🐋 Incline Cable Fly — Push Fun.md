...
## Full Body Time — Push focus (Fun) · 40-55 min
...
├─ 10 🛒 Medicine Ball Chest Pass (explore, stay within constraints)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 60s
═══
## 2) 🎼 Composition
Subcode: 🌾⌛🛒🟡 (Composition | Push | Time | Fun)
├─ 9 🛒 Single-Arm Cable Chest Fly → Incline Cable Fly (flow without reset)
...
├─ 9 🛒 Incline Cable Fly (explore, stay within constraints)
...
═══
## 4) 🧩 Supplemental
Subcode: 🌾⌛🛒🟡 (Supplemental | Push | Time | Fun)
