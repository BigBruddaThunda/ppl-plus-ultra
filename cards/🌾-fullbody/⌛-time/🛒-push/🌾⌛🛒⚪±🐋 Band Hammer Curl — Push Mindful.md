...
## Full Body Time — Push focus (Mindful) · 40-55 min
...
├─ 10 🛒 Single-Arm Overhead Dumbbell Hold (4s eccentric, breath-paced)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 120s
═══
## 2) 🧈 Bread & Butter
Subcode: 🌾⌛🛒⚪ (Bread & Butter | Push | Time | Mindful)
├─ 9 🛒 Single-Arm Cable Rear Delt Fly (4s eccentric, breath-paced)
...
├─ 10 🛒 Medicine Ball Chest Pass (parasympathetic, tension down, 4s eccentric)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 120s
═══
## 5) 🧬 Imprint
Subcode: 🌾⌛🛒⚪ (Imprint | Push | Time | Mindful)
├─ 10 🛒 Medicine Ball Slam (Chest Height) (high rep, low load, neural memory)
