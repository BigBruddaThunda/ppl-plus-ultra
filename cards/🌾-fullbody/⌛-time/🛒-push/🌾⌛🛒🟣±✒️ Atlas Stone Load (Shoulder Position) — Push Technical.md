...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# 🛒 Atlas Stone Load (Shoulder Position) — Push Technical 🛒

## Full Body Time — Push focus (Technical) · 40-55 min
...
├─ 10 🛒 Medicine Ball Chest Pass (precision, quality over volume)
│  Set 1: 🌾 50% × 10 (pattern prep)
Rest: 90s
═══
## 2) ▶️ Primer
Subcode: 🌾⌛🛒🟣 (Primer | Push | Time | Technical)
├─ 9 🛒 Sandbag Shouldering (tight setup, crisp intent)
│  Set 1: 🌾 60% × 9 (activation)
Rest: 90s
═══
## 3) 🧈 Bread & Butter
Subcode: 🌾⌛🛒🟣 (Bread & Butter | Push | Time | Technical)
├─ 9 🛒 Atlas Stone Load (Shoulder Position) (precision, quality over volume)
...
├─ 10 🛒 Single-Arm Incline Dumbbell Press (full range, different angle)
...
├─ 10 🛒 Single-Arm Landmine Press (Chest Focus) (smooth tempo, downshift)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 67s
═══
## 6) 🚂 Junction
