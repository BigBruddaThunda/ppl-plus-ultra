...
blocks: ♨️ 🎼 🧈 🧩 🪫 🚂
---
# 🪡 Face Pull (Rope) — Pull Intense 🪡

## Full Body Time — Pull focus (Intense) · 40-55 min
...
├─ 9 🪡 Face Pull (Rope) (high effort, push the pace)
...
├─ 10 🪡 Good Morning (Barbell) (all-out, leave nothing in reserve)
...
├─ 10 🪡 Good Morning (Barbell) (stress out, cathartic discharge)
│  Set 1: 🌾 50% × 10 (deload)
Rest: 30s
═══
## 7) 🚂 Junction
