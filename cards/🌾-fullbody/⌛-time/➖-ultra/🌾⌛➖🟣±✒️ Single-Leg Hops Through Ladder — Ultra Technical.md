...
## Full Body Time — Ultra focus (Technical) · 40-55 min
...
═══
## 2) 🎼 Composition
Subcode: 🌾⌛➖🟣 (Composition | Ultra | Time | Technical)
├─ 9 ➖ Turkish Get-Up (Full) → Single-Leg Hops Through Ladder (flow without reset)
