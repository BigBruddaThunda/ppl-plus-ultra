...
## Restoration Time — Legs focus (Teaching) · 30-40 min
...
├─ 13 🍗 Pogo Hops (Ankle Bounce) (coach: check grip width, elbow angle, foot pressure)
...
├─ 13 🍗 Lying Quad Stretch (Prone) (coached, check form before adding load)
