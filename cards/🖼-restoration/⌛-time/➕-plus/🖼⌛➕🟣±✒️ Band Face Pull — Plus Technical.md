...
## Restoration Time — Plus focus (Technical) · 30-40 min
...
├─ 13 ➕ Single-Leg Box Jump (precision, quality over volume)
│  Set 1: 🖼 55% × 13 (slow, feel each rep)
│  Set 2: 🖼 55% × 13 (same tempo, same breath)
Rest: 90s
═══
## 3) 🧬 Imprint
Subcode: 🖼⌛➕🟣 (Imprint | Plus | Time | Technical)
├─ 15 ➕ Single-Leg Lateral Hop (high rep, low load, neural memory)
