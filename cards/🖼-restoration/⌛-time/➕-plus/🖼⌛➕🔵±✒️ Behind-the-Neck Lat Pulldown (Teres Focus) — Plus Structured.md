...
## Restoration Time — Plus focus (Structured) · 30-40 min
...
├─ 12 ➕ Neutral-Grip Pull-Up (parasympathetic, tension down, 4s eccentric)
│  Set 1: 🖼 40% × 12 (deload)
Rest: 60s
═══
## 3) 🧈 Bread & Butter
Subcode: 🖼⌛➕🔵 (Bread & Butter | Plus | Time | Structured)
├─ 13 ➕ Pull-Up (Overhand Grip) (prescribed, track sets and reps)
