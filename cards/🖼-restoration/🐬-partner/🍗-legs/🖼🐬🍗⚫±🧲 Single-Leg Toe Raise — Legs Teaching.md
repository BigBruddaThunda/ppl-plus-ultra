...
## Restoration Partner — Legs focus (Teaching) · 30-40 min
...
├─ 13 🍗 Single-Leg Extension (coach: check grip width, elbow angle, foot pressure)
...
├─ 13 🍗 Single-Leg Toe Raise (coached, check form before adding load)
