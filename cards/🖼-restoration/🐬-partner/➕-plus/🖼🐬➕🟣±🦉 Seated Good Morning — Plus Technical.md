...
blocks: 🎯 🪫 🧈 🧬 🚂
---
# ➕ Kettlebell Swing (Single-Arm) — Plus Technical ➕

## Restoration Partner — Plus focus (Technical) · 30-40 min
...
├─ 13 ➕ Kettlebell Swing (Single-Arm) (precision, quality over volume)
│  Set 1: 🖼 55% × 13 (slow, feel each rep)
│  Set 2: 🖼 55% × 13 (same tempo, same breath)
Rest: 90s
═══
## 3) 🧬 Imprint
Subcode: 🖼🐬➕🟣 (Imprint | Plus | Partner | Technical)
├─ 15 ➕ Kettlebell Snatch (Single-Arm) (high rep, low load, neural memory)
