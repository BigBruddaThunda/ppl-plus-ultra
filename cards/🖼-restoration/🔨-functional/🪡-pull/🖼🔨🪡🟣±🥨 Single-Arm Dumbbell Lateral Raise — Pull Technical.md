...
blocks: 🎯 🪫 🧈 🧬 🚂
---
# 🪡 Single-Arm Dumbbell Lateral Raise — Pull Technical 🪡

## Restoration Functional — Pull focus (Technical) · 30-40 min
...
├─ 12 🪡 Alternating Dumbbell Front Raise (parasympathetic, tension down)
│  Set 1: 🖼 40% × 12 (deload)
Rest: 60s
═══
## 3) 🧈 Bread & Butter
Subcode: 🖼🔨🪡🟣 (Bread & Butter | Pull | Functional | Technical)
├─ 13 🪡 Single-Arm Dumbbell Lateral Raise (precision, quality over volume)
│  Set 1: 🖼 55% × 13 (slow, feel each rep)
│  Set 2: 🖼 55% × 13 (same tempo, same breath)
Rest: 60s
═══
## 4) 🧬 Imprint
Subcode: 🖼🔨🪡🟣 (Imprint | Pull | Functional | Technical)
├─ 17 🪡 Wide-Grip Lat Pulldown (Teres Focus) (high rep, low load, neural memory)
