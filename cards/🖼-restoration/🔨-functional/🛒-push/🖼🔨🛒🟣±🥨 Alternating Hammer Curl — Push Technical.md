...
blocks: 🎯 🪫 🧈 🧬 🚂
---
# 🛒 Alternating Hammer Curl — Push Technical 🛒

## Restoration Functional — Push focus (Technical) · 30-40 min
...
├─ 13 🛒 Alternating Hammer Curl (precision, quality over volume)
│  Set 1: 🖼 55% × 13 (slow, feel each rep)
│  Set 2: 🖼 55% × 13 (same tempo, same breath)
Rest: 60s
═══
## 4) 🧬 Imprint
Subcode: 🖼🔨🛒🟣 (Imprint | Push | Functional | Technical)
