...
## Restoration Functional — Legs focus (Structured) · 30-40 min
...
├─ 12 🍗 Conventional Deadlift (Glute Load) (parasympathetic, tension down, 4s eccentric)
│  Set 1: 🖼 40% × 12 (deload)
Rest: 60s
═══
## 3) 🧈 Bread & Butter
Subcode: 🖼🔨🍗🔵 (Bread & Butter | Legs | Functional | Structured)
├─ 13 🍗 Back Squat (Glute Focus) (prescribed, track sets and reps)
