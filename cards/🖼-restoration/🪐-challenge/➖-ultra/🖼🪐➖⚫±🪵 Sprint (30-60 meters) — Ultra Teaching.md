...
## Restoration Challenge — Ultra focus (Teaching) · 30-40 min
...
├─ 13 ➖ Overhead Throw (Medicine Ball) (coach: check grip width, elbow angle, foot pressure)
...
├─ 13 ➖ Single-Leg Hops Through Ladder (coached, check form before adding load)
