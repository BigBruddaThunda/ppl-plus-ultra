...
blocks: ♨️ 🪜 🧈 🚂
---
# 🪡 Pull-Up (Overhand Grip) — Pull Circuit 🪡

## Performance Challenge — Pull focus (Circuit) · 25-35 min
...
├─ 3 🪡 Wide-Grip Pull-Up (Teres Focus) (station rotation, keep moving)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🪐🪡🟠 (Progression | Pull | Challenge | Circuit)
├─ 2 🪡 Pull-Up (Overhand Grip) (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
## 3) 🧈 Bread & Butter
Subcode: 🏟🪐🪡🟠 (Bread & Butter | Pull | Challenge | Circuit)
├─ 2 🪡 Pull-Up (Overhand Grip) (station rotation, keep moving)
