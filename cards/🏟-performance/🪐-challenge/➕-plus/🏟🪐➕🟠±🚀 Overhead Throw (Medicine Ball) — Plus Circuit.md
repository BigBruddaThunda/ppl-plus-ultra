...
blocks: ♨️ 🪜 🧈 🚂
---
# ➕ Overhead Throw (Medicine Ball) — Plus Circuit ➕

## Performance Challenge — Plus focus (Circuit) · 25-35 min
...
│  Station 1: ➕ Overhead Throw (Medicine Ball) × 2 (station rotation, keep moving)
│  Station 2: ➕ Single-Leg Hops Through Ladder × 2 (station rotation, keep moving)
│  Station 3: ➕ Shot Put Throw (Single-Arm) × 2 (station rotation, keep moving)
│  Station 4: ➕ Archer Pull-Up × 2 (station rotation, keep moving)
