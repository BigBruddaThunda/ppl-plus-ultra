...
blocks: ♨️ 🪜 🧈 🚂
---
# ➕ Split Jerk — Plus Technical ➕

## Performance Challenge — Plus focus (Technical) · 25-35 min
...
├─ 3 ➕ Push Jerk (precision, quality over volume)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🪐➕🟣 (Progression | Plus | Challenge | Technical)
├─ 2 ➕ Split Jerk (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
...
├─ 2 ➕ Split Jerk (precision, quality over volume)
