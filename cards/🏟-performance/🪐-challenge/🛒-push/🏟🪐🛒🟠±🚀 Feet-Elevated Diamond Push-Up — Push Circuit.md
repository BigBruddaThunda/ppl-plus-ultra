...
blocks: ♨️ 🪜 🧈 🚂
---
# 🛒 Feet-Elevated Diamond Push-Up — Push Circuit 🛒

## Performance Challenge — Push focus (Circuit) · 25-35 min
...
═══
## 2) 🪜 Progression
Subcode: 🏟🪐🛒🟠 (Progression | Push | Challenge | Circuit)
├─ 2 🛒 Feet-Elevated Diamond Push-Up (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
## 3) 🧈 Bread & Butter
Subcode: 🏟🪐🛒🟠 (Bread & Butter | Push | Challenge | Circuit)
├─ 2 🛒 Feet-Elevated Diamond Push-Up (station rotation, keep moving)
