...
## Performance Challenge — Push focus (Structured) · 25-35 min
...
═══
## 2) 🪜 Progression
Subcode: 🏟🪐🛒🔵 (Progression | Push | Challenge | Structured)
├─ 2 🛒 Incline Chest Press Machine (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
...
├─ 2 🛒 Incline Chest Press Machine (prescribed, track sets and reps)
