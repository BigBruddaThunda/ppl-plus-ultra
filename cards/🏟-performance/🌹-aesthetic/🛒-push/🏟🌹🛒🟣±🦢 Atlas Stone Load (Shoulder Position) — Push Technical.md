...
## Performance Aesthetic — Push focus (Technical) · 25-35 min
...
├─ 3 🛒 Sandbag Shouldering (precision, quality over volume)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🌹🛒🟣 (Progression | Push | Aesthetic | Technical)
...
├─ 2 🛒 Atlas Stone Load (Shoulder Position) (precision, quality over volume)
