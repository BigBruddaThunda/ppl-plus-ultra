...
## Performance Aesthetic — Push focus (Bodyweight) · 25-35 min
...
├─ 3 🛒 Single-Arm Cable Chest Fly (bodyweight, no external load needed)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🌹🛒🟢 (Progression | Push | Aesthetic | Bodyweight)
...
├─ 2 🛒 Single-Arm Cable Rear Delt Fly (bodyweight, no external load needed)
