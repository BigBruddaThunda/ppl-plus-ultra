...
## Performance Aesthetic — Push focus (Circuit) · 25-35 min
...
├─ 3 🛒 Single-Arm Cable Chest Fly (station rotation, keep moving)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🌹🛒🟠 (Progression | Push | Aesthetic | Circuit)
├─ 2 🛒 Single-Arm Dumbbell Lateral Raise (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
## 3) 🧈 Bread & Butter
Subcode: 🏟🌹🛒🟠 (Bread & Butter | Push | Aesthetic | Circuit)
├─ 2 🛒 Single-Arm Dumbbell Lateral Raise (station rotation, keep moving)
