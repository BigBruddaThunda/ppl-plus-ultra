...
## Performance Aesthetic — Legs focus (Intense) · 25-35 min
...
═══
## 2) 🪜 Progression
Subcode: 🏟🌹🍗🔴 (Progression | Legs | Aesthetic | Intense)
├─ 2 🍗 Single-Leg Extension (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
...
├─ 2 🍗 Single-Leg Extension (high effort, push the pace)
