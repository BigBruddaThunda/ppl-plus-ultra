...
## Performance Aesthetic — Legs focus (Teaching) · 25-35 min
...
├─ 3 🍗 Standing Quad Stretch (coached, check form before adding load)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🌹🍗⚫ (Progression | Legs | Aesthetic | Teaching)
├─ 2 🍗 Lying Quad Stretch (Prone) (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
...
├─ 2 🍗 Lying Quad Stretch (Prone) (coached, check form before adding load)
