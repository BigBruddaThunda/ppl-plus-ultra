...
═══
## 2) 🪜 Progression
Subcode: 🏟🌹🪡🟠 (Progression | Pull | Aesthetic | Circuit)
├─ 2 🪡 Face Pull (Rope) (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
## 3) 🧈 Bread & Butter
Subcode: 🏟🌹🪡🟠 (Bread & Butter | Pull | Aesthetic | Circuit)
├─ 2 🪡 Face Pull (Rope) (station rotation, keep moving)
