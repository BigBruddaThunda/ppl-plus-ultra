...
## Performance Aesthetic — Pull focus (Technical) · 25-35 min
...
├─ 3 🪡 Yoke Walk (precision, quality over volume)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 135s
═══
## 2) 🪜 Progression
Subcode: 🏟🌹🪡🟣 (Progression | Pull | Aesthetic | Technical)
...
├─ 2 🪡 Atlas Stone Lift (precision, quality over volume)
