...
## Performance Aesthetic — Pull focus (Mindful) · 25-35 min
...
├─ 3 🪡 Cable Pullover (4s eccentric, breath-paced)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🌹🪡⚪ (Progression | Pull | Aesthetic | Mindful)
├─ 2 🪡 Band Hammer Curl (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
...
├─ 2 🪡 Band Hammer Curl (4s eccentric, breath-paced)
