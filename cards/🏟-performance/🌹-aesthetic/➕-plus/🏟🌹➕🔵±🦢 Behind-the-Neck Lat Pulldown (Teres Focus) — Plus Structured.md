...
## Performance Aesthetic — Plus focus (Structured) · 25-35 min
...
├─ 3 ➕ Neck Flexion (Bodyweight) (prescribed, track sets and reps)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🌹➕🔵 (Progression | Plus | Aesthetic | Structured)
├─ 2 ➕ Behind-the-Neck Lat Pulldown (Teres Focus) (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
...
├─ 2 ➕ Behind-the-Neck Lat Pulldown (Teres Focus) (prescribed, track sets and reps)
