...
## Performance Aesthetic — Plus focus (Fun) · 25-35 min
...
├─ 3 ➕ Neck Flexion (Bodyweight) (explore, stay within constraints)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🌹➕🟡 (Progression | Plus | Aesthetic | Fun)
├─ 2 ➕ Band Face Pull (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
...
├─ 2 ➕ Band Face Pull (explore, stay within constraints)
