...
## Performance Aesthetic — Plus focus (Teaching) · 25-35 min
...
├─ 3 ➕ Neck Flexion (Bodyweight) (coached, check form before adding load)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 135s
═══
## 2) 🛠 Craft
Subcode: 🏟🌹➕⚫ (Craft | Plus | Aesthetic | Teaching)
├─ 2 ➕ Wide-Grip Lat Pulldown (Teres Focus) (coach: check grip width, elbow angle, foot pressure)
...
├─ 2 ➕ Neck Flexion with Plate (Loaded) (coached, check form before adding load)
