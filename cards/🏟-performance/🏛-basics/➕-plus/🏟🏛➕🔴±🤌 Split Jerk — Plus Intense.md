...
## Performance Basics — Plus focus (Intense) · 25-35 min
...
├─ 3 ➕ Push Jerk (high effort, push the pace)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 45s
═══
## 2) 🪜 Progression
Subcode: 🏟🏛➕🔴 (Progression | Plus | Basics | Intense)
...
├─ 2 ➕ Split Jerk (high effort, push the pace)
