...
## Performance Basics — Pull focus (Mindful) · 25-35 min
...
═══
## 2) 🪜 Progression
Subcode: 🏟🏛🪡⚪ (Progression | Pull | Basics | Mindful)
├─ 2 🪡 Neutral-Grip Pull-Up (Brachialis) (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
...
├─ 2 🪡 Neutral-Grip Pull-Up (Brachialis) (4s eccentric, breath-paced)
