...
## Performance Basics — Ultra focus (Structured) · 25-35 min
...
├─ 3 ➖ Rowing Machine (Steady State) (prescribed, track sets and reps)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🏛➖🔵 (Progression | Ultra | Basics | Structured)
...
├─ 2 ➖ Two Feet In Each Box (Forward) (prescribed, track sets and reps)
