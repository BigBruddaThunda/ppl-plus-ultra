...
## Performance Time — Push focus (Technical) · 25-35 min
...
├─ 3 🛒 Plyometric Push-Up (Hands Leave Ground) (precision, quality over volume)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟⌛🛒🟣 (Progression | Push | Time | Technical)
