...
## Performance Functional — Pull focus (Structured) · 25-35 min
...
├─ 3 🪡 Single-Arm Row (Rhomboid Emphasis) (prescribed, track sets and reps)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🔨🪡🔵 (Progression | Pull | Functional | Structured)
