...
## Performance Functional — Pull focus (Circuit) · 25-35 min
...
═══
## 2) 🪜 Progression
Subcode: 🏟🔨🪡🟠 (Progression | Pull | Functional | Circuit)
...
═══
## 3) 🧈 Bread & Butter
Subcode: 🏟🔨🪡🟠 (Bread & Butter | Pull | Functional | Circuit)
├─ 2 🪡 Archer Pull-Up (station rotation, keep moving)
