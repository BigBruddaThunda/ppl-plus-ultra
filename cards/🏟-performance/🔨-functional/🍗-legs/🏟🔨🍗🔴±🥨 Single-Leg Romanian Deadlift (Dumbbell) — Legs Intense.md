...
blocks: ♨️ 🪜 🧈 🚂
---
# 🍗 Single-Leg Romanian Deadlift (Dumbbell) — Legs Intense 🍗

## Performance Functional — Legs focus (Intense) · 25-35 min
...
├─ 3 🍗 Single-Leg Pogo Hops (high effort, push the pace)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 45s
═══
## 2) 🪜 Progression
Subcode: 🏟🔨🍗🔴 (Progression | Legs | Functional | Intense)
├─ 2 🍗 Single-Leg Romanian Deadlift (Dumbbell) (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
...
├─ 2 🍗 Single-Leg Romanian Deadlift (Dumbbell) (high effort, push the pace)
