...
blocks: ♨️ 🪜 🧈 🚂
---
# 🍗 Single-Leg Romanian Deadlift (Barbell) — Legs Circuit 🍗

## Performance Functional — Legs focus (Circuit) · 25-35 min
...
═══
## 2) 🪜 Progression
Subcode: 🏟🔨🍗🟠 (Progression | Legs | Functional | Circuit)
├─ 2 🍗 Single-Leg Romanian Deadlift (Barbell) (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
## 3) 🧈 Bread & Butter
Subcode: 🏟🔨🍗🟠 (Bread & Butter | Legs | Functional | Circuit)
├─ 2 🍗 Single-Leg Romanian Deadlift (Barbell) (station rotation, keep moving)
