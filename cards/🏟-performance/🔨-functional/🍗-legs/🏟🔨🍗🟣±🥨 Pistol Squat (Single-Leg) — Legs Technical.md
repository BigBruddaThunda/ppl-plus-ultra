...
blocks: ♨️ 🪜 🧈 🚂
---
# 🍗 Pistol Squat (Single-Leg) — Legs Technical 🍗

## Performance Functional — Legs focus (Technical) · 25-35 min
...
├─ 3 🍗 Cossack Squat (precision, quality over volume)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 135s
═══
## 2) 🪜 Progression
Subcode: 🏟🔨🍗🟣 (Progression | Legs | Functional | Technical)
├─ 2 🍗 Pistol Squat (Single-Leg) (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
...
├─ 2 🍗 Pistol Squat (Single-Leg) (precision, quality over volume)
