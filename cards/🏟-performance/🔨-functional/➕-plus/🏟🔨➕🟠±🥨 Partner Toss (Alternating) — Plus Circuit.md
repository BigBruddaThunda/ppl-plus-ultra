...
## Performance Functional — Plus focus (Circuit) · 25-35 min
...
═══
## 2) 🪜 Progression
Subcode: 🏟🔨➕🟠 (Progression | Plus | Functional | Circuit)
├─ 2 ➕ Partner Toss (Alternating) (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
## 3) 🧈 Bread & Butter
Subcode: 🏟🔨➕🟠 (Bread & Butter | Plus | Functional | Circuit)
├─ 2 ➕ Partner Toss (Alternating) (station rotation, keep moving)
