...
## Performance Functional — Plus focus (Structured) · 25-35 min
...
├─ 3 ➕ Shot Put Throw (Single-Arm) (prescribed, track sets and reps)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🔨➕🔵 (Progression | Plus | Functional | Structured)
...
├─ 2 ➕ Overhead Throw (Medicine Ball) (prescribed, track sets and reps)
