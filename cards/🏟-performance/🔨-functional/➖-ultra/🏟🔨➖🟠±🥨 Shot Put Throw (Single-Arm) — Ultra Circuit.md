...
blocks: ♨️ 🪜 🧈 🚂
---
# ➖ Shot Put Throw (Single-Arm) — Ultra Circuit ➖

## Performance Functional — Ultra focus (Circuit) · 25-35 min
...
═══
## 2) 🪜 Progression
Subcode: 🏟🔨➖🟠 (Progression | Ultra | Functional | Circuit)
├─ 2 ➖ Shot Put Throw (Single-Arm) (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
## 3) 🧈 Bread & Butter
Subcode: 🏟🔨➖🟠 (Bread & Butter | Ultra | Functional | Circuit)
├─ 2 ➖ Shot Put Throw (Single-Arm) (station rotation, keep moving)
