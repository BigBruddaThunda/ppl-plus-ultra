...
## Performance Functional — Ultra focus (Structured) · 25-35 min
...
├─ 3 ➖ Single-Leg Hops Through Ladder (prescribed, track sets and reps)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🔨➖🔵 (Progression | Ultra | Functional | Structured)
