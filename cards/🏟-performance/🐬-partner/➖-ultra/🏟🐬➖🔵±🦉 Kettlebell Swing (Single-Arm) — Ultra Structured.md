...
## Performance Partner — Ultra focus (Structured) · 25-35 min
...
├─ 3 ➖ Kettlebell Swing (Single-Arm) (prescribed, track sets and reps)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🐬➖🔵 (Progression | Ultra | Partner | Structured)
...
├─ 2 ➖ Kettlebell Swing (Single-Arm) (prescribed, track sets and reps)
