...
## Performance Partner — Ultra focus (Teaching) · 25-35 min
...
├─ 2 ➖ Single-Leg Hops Through Ladder (coach: check grip width, elbow angle, foot pressure)
...
├─ 2 ➖ Kettlebell Swing (Alternating Arms) (coached, check form before adding load)
