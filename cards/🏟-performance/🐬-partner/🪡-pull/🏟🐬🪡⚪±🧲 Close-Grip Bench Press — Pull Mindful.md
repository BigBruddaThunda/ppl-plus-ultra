...
blocks: ♨️ 🪜 🧈 🚂
---
# 🪡 Close-Grip Bench Press — Pull Mindful 🪡

## Performance Partner — Pull focus (Mindful) · 25-35 min
...
═══
## 2) 🪜 Progression
Subcode: 🏟🐬🪡⚪ (Progression | Pull | Partner | Mindful)
├─ 2 🪡 Close-Grip Bench Press (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
...
├─ 2 🪡 Close-Grip Bench Press (4s eccentric, breath-paced)
