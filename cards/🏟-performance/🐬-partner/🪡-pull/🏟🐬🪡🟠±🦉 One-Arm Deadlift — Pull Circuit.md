...
═══
## 2) 🪜 Progression
Subcode: 🏟🐬🪡🟠 (Progression | Pull | Partner | Circuit)
├─ 2 🪡 One-Arm Deadlift (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
## 3) 🧈 Bread & Butter
Subcode: 🏟🐬🪡🟠 (Bread & Butter | Pull | Partner | Circuit)
├─ 2 🪡 One-Arm Deadlift (station rotation, keep moving)
