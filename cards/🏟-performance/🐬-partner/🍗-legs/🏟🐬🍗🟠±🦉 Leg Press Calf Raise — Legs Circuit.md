...
blocks: ♨️ 🪜 🧈 🚂
---
# 🍗 Leg Press Calf Raise — Legs Circuit 🍗

## Performance Partner — Legs focus (Circuit) · 25-35 min
...
├─ 3 🍗 Deep Squat Hold (Ankle Mobility) (station rotation, keep moving)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🐬🍗🟠 (Progression | Legs | Partner | Circuit)
├─ 2 🍗 Leg Press Calf Raise (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
## 3) 🧈 Bread & Butter
Subcode: 🏟🐬🍗🟠 (Bread & Butter | Legs | Partner | Circuit)
├─ 2 🍗 Leg Press Calf Raise (station rotation, keep moving)
