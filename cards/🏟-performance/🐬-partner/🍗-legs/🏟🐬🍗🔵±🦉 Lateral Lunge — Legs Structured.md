...
## Performance Partner — Legs focus (Structured) · 25-35 min
...
├─ 3 🍗 Deep Squat Hold (Ankle Mobility) (prescribed, track sets and reps)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🐬🍗🔵 (Progression | Legs | Partner | Structured)
├─ 2 🍗 Lateral Lunge (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
...
├─ 2 🍗 Lateral Lunge (prescribed, track sets and reps)
