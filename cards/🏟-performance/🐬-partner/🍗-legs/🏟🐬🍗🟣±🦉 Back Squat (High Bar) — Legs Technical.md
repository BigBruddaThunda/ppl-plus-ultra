...
blocks: ♨️ 🪜 🧈 🚂
---
# 🍗 Back Squat (High Bar) — Legs Technical 🍗

## Performance Partner — Legs focus (Technical) · 25-35 min
...
═══
## 2) 🪜 Progression
Subcode: 🏟🐬🍗🟣 (Progression | Legs | Partner | Technical)
├─ 2 🍗 Back Squat (High Bar) (ramp to test weight)
│  Set 1: 🏟 77% × 3 (opener)
│  Set 2: 🏟 87% × 2 (bridge)
Rest: Full recovery
═══
...
├─ 2 🍗 Back Squat (High Bar) (precision, quality over volume)
