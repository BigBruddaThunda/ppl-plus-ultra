...
blocks: ♨️ 🪜 🧈 🚂
---
# ➕ Kettlebell Swing (Single-Arm) — Plus Circuit ➕

## Performance Partner — Plus focus (Circuit) · 25-35 min
...
├─ 3 ➕ Shot Put Throw (Single-Arm) (station rotation, keep moving)
│  Set 1: 🏟 72% × 3 (pattern prep)
Rest: 90s
═══
## 2) 🪜 Progression
Subcode: 🏟🐬➕🟠 (Progression | Plus | Partner | Circuit)
...
═══
## 3) 🧈 Bread & Butter
Subcode: 🏟🐬➕🟠 (Bread & Butter | Plus | Partner | Circuit)
├─ 2 ➕ Kettlebell Swing (Single-Arm) (station rotation, keep moving)
