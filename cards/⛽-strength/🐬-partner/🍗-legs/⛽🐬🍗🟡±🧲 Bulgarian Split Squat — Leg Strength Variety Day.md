...
# 🍗 Bulgarian Split Squat — Leg Strength Variety Day 🍗
...
Sub-block: ♨️🍗🐬🟡 (Warm-Up | Legs | Partner | Fun)
...
Sub-block: ▶️🍗🐬🟡 (Primer | Legs | Partner | Fun)
...
Primary Pattern: **Bulgarian Split Squat**

🧲 capio — partner-governed heavy work

Sub-block: 🧈🍗🐬🟡 (Bread & Butter | Legs | Partner | Fun)

- 5 🍗 Bulgarian Split Squat (partner setup check)
...
Sub-block: 🧩🍗🐬🟡 (Supplemental | Legs | Partner | Fun)
