...
# 🪡 Ring Row — Pull Station Rotation 🪡
...
Sub-block: ♨️🪡🐬🟠 (Warm-Up | Pull | Partner | Circuit)
...
Sub-block: ▶️🪡🐬🟠 (Primer | Pull | Partner | Circuit)
...
Primary Pattern: **Ring Row**

🦉 logos — partner-governed heavy work

Sub-block: 🎱🪡🐬🟠 (ARAM | Pull | Partner | Circuit)

- 5 🪡 Ring Row (partner setup check)
...
Sub-block: 🧩🪡🐬🟠 (Supplemental | Pull | Partner | Circuit)
