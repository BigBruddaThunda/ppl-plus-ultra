...
# ➖ Jump Rope Sprint Intervals — Engine Station Rotation ➖
...
Sub-block: ♨️➖🐬🟠 (Warm-Up | Ultra | Partner | Circuit)
...
Sub-block: ▶️➖🐬🟠 (Primer | Ultra | Partner | Circuit)
...
Primary Pattern: **Jump Rope Sprint Intervals**

🦉 logos — partner-governed heavy work

Sub-block: 🎱➖🐬🟠 (ARAM | Ultra | Partner | Circuit)

- 5 ➖ Jump Rope Sprint Intervals (partner setup check)
...
Sub-block: 🧩➖🐬🟠 (Supplemental | Ultra | Partner | Circuit)
