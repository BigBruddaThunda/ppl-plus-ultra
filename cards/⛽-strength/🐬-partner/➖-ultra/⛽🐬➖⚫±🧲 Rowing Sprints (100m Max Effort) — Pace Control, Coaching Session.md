...
type: ➖ Ultra | Partner-context strength emphasis
color: ⚫ Teaching | Partner deployment logic
blocks: ♨️ ▶️ 🧈 🧩 🪫 🚂
---

# ➖ Rowing Sprints (100m Max Effort) — Pace Control, Coaching Session ➖

Partner strength conditioning | Engine and repeat power | 45-60 min
...
Sub-block: ♨️➖🐬⚫ (Warm-Up | Ultra | Partner | Teaching)
...
Sub-block: ▶️➖🐬⚫ (Primer | Ultra | Partner | Teaching)
...
Primary Pattern: **Rowing Sprints (100m Max Effort)**

🧲 capio — partner-governed heavy work

Sub-block: 🧈➖🐬⚫ (Bread & Butter | Ultra | Partner | Teaching)

- 5 ➖ Rowing Sprints (100m Max Effort) (partner setup check)
...
Sub-block: 🧩➖🐬⚫ (Supplemental | Ultra | Partner | Teaching)
