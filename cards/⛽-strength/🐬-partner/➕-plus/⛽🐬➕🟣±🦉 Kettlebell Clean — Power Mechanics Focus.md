...
# ➕ Kettlebell Clean — Power Mechanics Focus ➕
...
Sub-block: ♨️➕🐬🟣 (Warm-Up | Plus | Partner | Technical)
...
Sub-block: ▶️➕🐬🟣 (Primer | Plus | Partner | Technical)
...
Primary Pattern: **Kettlebell Clean**

🦉 logos — partner-governed heavy work

Sub-block: 🧈➕🐬🟣 (Bread & Butter | Plus | Partner | Technical)

- 5 ➕ Kettlebell Clean (partner setup check)
...
Sub-block: 🧩➕🐬🟣 (Supplemental | Plus | Partner | Technical)
