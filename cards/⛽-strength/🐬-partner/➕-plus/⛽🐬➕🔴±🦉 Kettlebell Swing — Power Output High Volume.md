...
# ➕ Kettlebell Swing — Power Output High Volume ➕
...
Sub-block: ♨️➕🐬🔴 (Warm-Up | Plus | Partner | Intense)
...
Sub-block: ▶️➕🐬🔴 (Primer | Plus | Partner | Intense)
...
Sub-block: 🧈➕🐬🔴 (Bread & Butter | Plus | Partner | Intense)

- 5 ➕ Kettlebell Swing (partner setup check)
...
Sub-block: 🧩➕🐬🔴 (Supplemental | Plus | Partner | Intense)
