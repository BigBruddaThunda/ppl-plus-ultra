...
# ➕ Trap Bar Carry — Carry and Brace, Coaching Session ➕
...
Sub-block: ♨️➕🐬⚫ (Warm-Up | Plus | Partner | Teaching)
...
Sub-block: ▶️➕🐬⚫ (Primer | Plus | Partner | Teaching)
...
Sub-block: 🧈➕🐬⚫ (Bread & Butter | Plus | Partner | Teaching)

- 5 ➕ Trap Bar Carry (partner setup check)
...
Sub-block: 🧩➕🐬⚫ (Supplemental | Plus | Partner | Teaching)
