...
# ➕ Plank — Core Control Slow Eccentric ➕
...
Sub-block: ♨️➕🐬⚪ (Warm-Up | Plus | Partner | Mindful)
...
Sub-block: ▶️➕🐬⚪ (Primer | Plus | Partner | Mindful)
...
Primary Pattern: **Plank**

🧲 capio — partner-governed heavy work

Sub-block: 🧈➕🐬⚪ (Bread & Butter | Plus | Partner | Mindful)

- 5 ➕ Plank (partner setup check)
...
Sub-block: 🧩➕🐬⚪ (Supplemental | Plus | Partner | Mindful)
