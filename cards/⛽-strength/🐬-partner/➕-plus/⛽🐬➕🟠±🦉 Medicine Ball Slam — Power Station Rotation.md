...
# ➕ Medicine Ball Slam — Power Station Rotation ➕
...
Sub-block: ♨️➕🐬🟠 (Warm-Up | Plus | Partner | Circuit)
...
Sub-block: ▶️➕🐬🟠 (Primer | Plus | Partner | Circuit)
...
Primary Pattern: **Medicine Ball Slam**

🦉 logos — partner-governed heavy work

Sub-block: 🎱➕🐬🟠 (ARAM | Plus | Partner | Circuit)

- 5 ➕ Medicine Ball Slam (partner setup check)
...
Sub-block: 🧩➕🐬🟠 (Supplemental | Plus | Partner | Circuit)
