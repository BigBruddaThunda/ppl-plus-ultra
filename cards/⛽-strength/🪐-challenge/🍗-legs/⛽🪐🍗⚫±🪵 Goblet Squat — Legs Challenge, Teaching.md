...
# 🍗 Goblet Squat — Legs Challenge, Teaching 🍗
...
Sub-block: ♨️🍗🪐⚫ (Warm-Up | Legs | Challenge | Teaching)
...
Sub-block: ▶️🍗🪐⚫ (Primer | Legs | Challenge | Teaching)

├─ Set 1: ⛽ 60% × 6 on Goblet Squat (controlled depth)
├─ Set 2: ⛽ 68% × 5 on Goblet Squat (2-second pause)
└─ Set 3: ⛽ 72% × 4 on Goblet Squat (same strict line)
...
Sub-block: 🧈🍗🪐⚫ (Bread & Butter | Legs | Challenge | Teaching)

├─ 5 🍗 Goblet Squat (hardest clean variation today)
...
Sub-block: 🧩🍗🪐⚫ (SUPPLEMENTAL | Legs | Challenge | Teaching)
...
Sub-block: 🪫🍗🪐⚫ (Release | Legs | Challenge | Teaching)
...
Sub-block: 🚂🍗🪐⚫ (Junction | Legs | Challenge | Teaching)
