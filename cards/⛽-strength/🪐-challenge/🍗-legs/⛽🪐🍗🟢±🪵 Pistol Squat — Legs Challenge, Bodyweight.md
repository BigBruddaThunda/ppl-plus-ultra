...
# 🍗 Pistol Squat — Legs Challenge, Bodyweight 🍗
...
Sub-block: ♨️🍗🪐🟢 (Warm-Up | Legs | Challenge | Bodyweight)
...
Sub-block: ▶️🍗🪐🟢 (Primer | Legs | Challenge | Bodyweight)

├─ Set 1: ⛽ 60% × 6 on Pistol Squat (controlled depth)
├─ Set 2: ⛽ 68% × 5 on Pistol Squat (2-second pause)
└─ Set 3: ⛽ 72% × 4 on Pistol Squat (same strict line)
...
Sub-block: 🧈🍗🪐🟢 (Bread & Butter | Legs | Challenge | Bodyweight)

├─ 5 🍗 Pistol Squat (hardest clean variation today)
...
Sub-block: 🧩🍗🪐🟢 (SUPPLEMENTAL | Legs | Challenge | Bodyweight)
...
Sub-block: 🪫🍗🪐🟢 (Release | Legs | Challenge | Bodyweight)
...
Sub-block: 🚂🍗🪐🟢 (Junction | Legs | Challenge | Bodyweight)
