...
# 🛒 Kettlebell Push Press — Push Challenge, Circuit 🛒
...
Sub-block: ♨️🛒🪐🟠 (Warm-Up | Push | Challenge | Circuit)
...
Sub-block: ▶️🛒🪐🟠 (Primer | Push | Challenge | Circuit)

├─ Set 1: ⛽ 60% × 6 on Kettlebell Push Press (controlled depth)
├─ Set 2: ⛽ 68% × 5 on Kettlebell Push Press (2-second pause)
└─ Set 3: ⛽ 72% × 4 on Kettlebell Push Press (same strict line)
...
Sub-block: 🧈🛒🪐🟠 (Bread & Butter | Push | Challenge | Circuit)

├─ 5 🛒 Kettlebell Push Press (hardest clean variation today)
...
Sub-block: 🎱🛒🪐🟠 (ARAM | Push | Challenge | Circuit)
...
Sub-block: 🪫🛒🪐🟠 (Release | Push | Challenge | Circuit)
...
Sub-block: 🚂🛒🪐🟠 (Junction | Push | Challenge | Circuit)
