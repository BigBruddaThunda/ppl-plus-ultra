...
├─ 6 ➖ Sprint (60-100 meters) (full range, different angle)
...
├─ 6 ➖ Hill Sprint (Short) (parasympathetic, tension down, 4s eccentric)
│  Set 1: ⛽ 60% × 6 (deload)
Rest: 240s
═══
## 5) 🧬 Imprint
Subcode: ⛽🪐➖⚪ (Imprint | Ultra | Challenge | Mindful)
├─ 6 ➖ Hill Sprint (Long) (high rep, low load, neural memory)
