...
# ➖ Jump Rope Sprint Intervals — Ultra Challenge, Circuit ➖
...
Sub-block: ♨️➖🪐🟠 (Warm-Up | Ultra | Challenge | Circuit)
...
Sub-block: ▶️➖🪐🟠 (Primer | Ultra | Challenge | Circuit)

├─ Set 1: ⛽ 60% × 6 on Jump Rope Sprint Intervals (controlled depth)
├─ Set 2: ⛽ 68% × 5 on Jump Rope Sprint Intervals (2-second pause)
└─ Set 3: ⛽ 72% × 4 on Jump Rope Sprint Intervals (same strict line)
...
Sub-block: 🧈➖🪐🟠 (Bread & Butter | Ultra | Challenge | Circuit)

├─ 5 ➖ Jump Rope Sprint Intervals (hardest clean variation today)
...
Sub-block: 🎱➖🪐🟠 (ARAM | Ultra | Challenge | Circuit)
...
Sub-block: 🪫➖🪐🟠 (Release | Ultra | Challenge | Circuit)
...
Sub-block: 🚂➖🪐🟠 (Junction | Ultra | Challenge | Circuit)
