...
# ➕ Thrusters — Plus Challenge, Intense ➕
...
Sub-block: ♨️➕🪐🔴 (Warm-Up | Plus | Challenge | Intense)
...
Sub-block: ▶️➕🪐🔴 (Primer | Plus | Challenge | Intense)

├─ Set 1: ⛽ 60% × 6 on Thrusters (controlled depth)
├─ Set 2: ⛽ 68% × 5 on Thrusters (2-second pause)
└─ Set 3: ⛽ 72% × 4 on Thrusters (same strict line)
...
Sub-block: 🧈➕🪐🔴 (Bread & Butter | Plus | Challenge | Intense)

├─ 5 ➕ Thrusters (hardest clean variation today)
...
Sub-block: 🧩➕🪐🔴 (SUPPLEMENTAL | Plus | Challenge | Intense)
...
Sub-block: 🪫➕🪐🔴 (Release | Plus | Challenge | Intense)
...
Sub-block: 🚂➕🪐🔴 (Junction | Plus | Challenge | Intense)
