...
# ➕ Bear Crawl — Plus Challenge, Bodyweight ➕
...
Sub-block: ♨️➕🪐🟢 (Warm-Up | Plus | Challenge | Bodyweight)
...
Sub-block: ▶️➕🪐🟢 (Primer | Plus | Challenge | Bodyweight)

├─ Set 1: ⛽ 60% × 6 on Bear Crawl (controlled depth)
├─ Set 2: ⛽ 68% × 5 on Bear Crawl (2-second pause)
└─ Set 3: ⛽ 72% × 4 on Bear Crawl (same strict line)
...
Sub-block: 🧈➕🪐🟢 (Bread & Butter | Plus | Challenge | Bodyweight)

├─ 5 ➕ Bear Crawl (hardest clean variation today)
...
Sub-block: 🧩➕🪐🟢 (SUPPLEMENTAL | Plus | Challenge | Bodyweight)
...
Sub-block: 🪫➕🪐🟢 (Release | Plus | Challenge | Bodyweight)
...
Sub-block: 🚂➕🪐🟢 (Junction | Plus | Challenge | Bodyweight)
