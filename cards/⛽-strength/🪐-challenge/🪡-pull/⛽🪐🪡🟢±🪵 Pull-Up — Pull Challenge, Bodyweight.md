...
# 🪡 Pull-Up — Pull Challenge, Bodyweight 🪡
...
Sub-block: ♨️🪡🪐🟢 (Warm-Up | Pull | Challenge | Bodyweight)
...
Sub-block: ▶️🪡🪐🟢 (Primer | Pull | Challenge | Bodyweight)

├─ Set 1: ⛽ 60% × 6 on Pull-Up (controlled depth)
├─ Set 2: ⛽ 68% × 5 on Pull-Up (2-second pause)
└─ Set 3: ⛽ 72% × 4 on Pull-Up (same strict line)
...
Sub-block: 🧈🪡🪐🟢 (Bread & Butter | Pull | Challenge | Bodyweight)

├─ 5 🪡 Pull-Up (hardest clean variation today)
...
Sub-block: 🧩🪡🪐🟢 (SUPPLEMENTAL | Pull | Challenge | Bodyweight)
...
Sub-block: 🪫🪡🪐🟢 (Release | Pull | Challenge | Bodyweight)
...
Sub-block: 🚂🪡🪐🟢 (Junction | Pull | Challenge | Bodyweight)
