...
# 🪡 Chest-Supported Dumbbell Row — Pull Challenge, Teaching 🪡
...
Sub-block: ♨️🪡🪐⚫ (Warm-Up | Pull | Challenge | Teaching)
...
Sub-block: ▶️🪡🪐⚫ (Primer | Pull | Challenge | Teaching)

├─ Set 1: ⛽ 60% × 6 on Chest-Supported Dumbbell Row (controlled depth)
├─ Set 2: ⛽ 68% × 5 on Chest-Supported Dumbbell Row (2-second pause)
└─ Set 3: ⛽ 72% × 4 on Chest-Supported Dumbbell Row (same strict line)
...
Sub-block: 🧈🪡🪐⚫ (Bread & Butter | Pull | Challenge | Teaching)

├─ 5 🪡 Chest-Supported Dumbbell Row (hardest clean variation today)
...
Sub-block: 🧩🪡🪐⚫ (SUPPLEMENTAL | Pull | Challenge | Teaching)
...
Sub-block: 🪫🪡🪐⚫ (Release | Pull | Challenge | Teaching)
...
Sub-block: 🚂🪡🪐⚫ (Junction | Pull | Challenge | Teaching)
