...
type: ➖ Ultra | Cardiovascular system, conditioning
color: 🔵 Structured
blocks: ♨️ ▶️ 🧈 🧩 🪫 🚂
---
...
Sub-block: ♨️➖🌹🔵 (Warm-Up | Ultra | Aesthetic | Structured)
...
Sub-block: ▶️➖🌹🔵 (Primer | Ultra | Aesthetic | Structured)

├─ Set 1: ⛽ 55% × 6 efforts on Assault Bike Intervals (1:1) (find pace)
├─ Set 2: ⛽ 65% × 5 efforts on Assault Bike Intervals (1:1) (steady split)
└─ Set 3: ⛽ 72% × 4 efforts on Assault Bike Intervals (1:1) (hard but controlled)
...
Sub-block: 🧈➖🌹🔵 (Bread & Butter | Ultra | Aesthetic | Structured)

├─ 5 ➖ Assault Bike Intervals (1:1) (repeat hard, hold form)
│  ├─ Set 1: ⛽ 75% × 5 efforts
│  ├─ Set 2: ⛽ 78% × 5 efforts
│  ├─ Set 3: ⛽ 82% × 4 efforts
│  └─ Set 4: ⛽ 85% × 4 efforts
└─ 4 ➖ Bike Sprints (10-30 seconds) (same pace target)
   ├─ Set 1: ⛽ 76% × 4 efforts
   ├─ Set 2: ⛽ 78% × 4 efforts
   └─ Set 3: ⛽ 80% × 4 efforts
...
Sub-block: 🧩➖🌹🔵 (Supplemental | Ultra | Aesthetic | Structured)

├─ 5 ➖ Rowing Intervals (1000m) (stay smooth under fatigue)
│  ├─ Set 1: ⛽ 75% × 5 efforts
│  ├─ Set 2: ⛽ 78% × 4 efforts
│  └─ Set 3: ⛽ 80% × 4 efforts
└─ 5 ➖ Ski Erg Sprints (30-60 seconds) (finish each interval clean)
   ├─ Set 1: ⛽ 74% × 5 efforts
   ├─ Set 2: ⛽ 76% × 5 efforts
   └─ Set 3: ⛽ 78% × 4 efforts
...
Sub-block: 🪫➖🌹🔵 (Release | Ultra | Aesthetic | Structured)
...
Sub-block: 🚂➖🌹🔵 (Junction | Ultra | Aesthetic | Structured)
