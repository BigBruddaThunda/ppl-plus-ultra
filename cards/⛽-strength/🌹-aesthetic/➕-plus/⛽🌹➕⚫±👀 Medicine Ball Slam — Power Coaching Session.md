...
## Strength Aesthetic — Plus focus (Teaching) · 50-65 min
...
├─ 6 ➕ Aquaman (Alternating Superman) (coached, check form before adding load)
│  Set 1: ⛽ 60% × 6 (pattern prep)
Rest: 135s
═══
## 2) 🛠 Craft
Subcode: ⛽🌹➕⚫ (Craft | Plus | Aesthetic | Teaching)
├─ 5 ➕ Half-Kneeling Band Single-Arm Pulldown (coach: check grip width, elbow angle, foot pressure)
...
├─ 6 ➕ Single-Leg Plank (full range, different angle)
...
├─ 6 ➕ Single-Arm Single-Leg Plank (high rep, low load, neural memory)
