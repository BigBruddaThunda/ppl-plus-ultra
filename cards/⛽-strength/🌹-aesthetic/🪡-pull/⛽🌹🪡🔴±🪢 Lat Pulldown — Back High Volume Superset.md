...
├─ 6 🪡 Sandbag Shouldering (high effort, push the pace)
│  Set 1: ⛽ 60% × 6 (pattern prep)
Rest: 45s
═══
## 2) ▶️ Primer
Subcode: ⛽🌹🪡🔴 (Primer | Pull | Aesthetic | Intense)
├─ 5 🪡 Atlas Stone Load (Shoulder Position) (tight setup, crisp intent)
│  Set 1: ⛽ 70% × 5 (activation)
Rest: 60s
═══
## 3) 🧈 Bread & Butter
Subcode: ⛽🌹🪡🔴 (Bread & Butter | Pull | Aesthetic | Intense)
├─ 5 🪡 Single-Arm Cable Rear Delt Fly (high effort, push the pace)
