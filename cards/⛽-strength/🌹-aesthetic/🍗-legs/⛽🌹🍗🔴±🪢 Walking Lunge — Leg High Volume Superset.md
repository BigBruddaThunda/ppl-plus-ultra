...
├─ 5 🍗 Pogo Hops (Ankle Bounce) (tight setup, crisp intent)
...
├─ 6 🍗 Box Jump (Calf Power) (full range, different angle)
...
├─ 6 🍗 Depth Drop (Reactive Calf) (all-out, leave nothing in reserve)
...
├─ 6 🍗 Depth Drop (Reactive Calf) (stress out, cathartic discharge)
│  Set 1: ⛽ 60% × 6 (deload)
Rest: 60s
═══
## 7) 🚂 Junction
