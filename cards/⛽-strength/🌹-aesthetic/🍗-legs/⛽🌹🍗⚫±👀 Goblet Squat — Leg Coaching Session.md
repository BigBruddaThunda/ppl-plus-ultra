...
# 🍗 Goblet Squat — Leg Coaching Session 🍗
...
Sub-block: ♨️🍗🌹⚫ (Warm-Up | Legs | Aesthetic | Teaching)
...
Sub-block: ▶️🍗🌹⚫ (Primer | Legs | Aesthetic | Teaching)

├─ Set 1: ⛽ 55% × 6 on Goblet Squat (find stance)
├─ Set 2: ⛽ 65% × 5 on Goblet Squat (steady descent)
└─ Set 3: ⛽ 72% × 4 on Goblet Squat (drive hard, no rush)
...
Sub-block: 🧈🍗🌹⚫ (Bread & Butter | Legs | Aesthetic | Teaching)

├─ 5 🍗 Goblet Squat (deep range, strong finish)
│  ├─ Set 1: ⛽ 75% × 5
│  ├─ Set 2: ⛽ 78% × 5
│  ├─ Set 3: ⛽ 82% × 4
│  └─ Set 4: ⛽ 85% × 4
└─ 4 🍗 Leg Extension Machine (tension never drops)
   ├─ Set 1: ⛽ 76% × 4
   ├─ Set 2: ⛽ 78% × 4
   └─ Set 3: ⛽ 80% × 4
...
Sub-block: 🧩🍗🌹⚫ (Supplemental | Legs | Aesthetic | Teaching)

├─ 5 🍗 Lying Leg Curl (drive through mid-foot)
│  ├─ Set 1: ⛽ 75% × 5
│  ├─ Set 2: ⛽ 78% × 4
│  └─ Set 3: ⛽ 80% × 4
└─ 5 🍗 Standing Calf Raise Machine (full stretch, full finish)
   ├─ Set 1: ⛽ 74% × 5
   ├─ Set 2: ⛽ 76% × 5
   └─ Set 3: ⛽ 78% × 4
...
Sub-block: 🪫🍗🌹⚫ (Release | Legs | Aesthetic | Teaching)
...
Sub-block: 🚂🍗🌹⚫ (Junction | Legs | Aesthetic | Teaching)
