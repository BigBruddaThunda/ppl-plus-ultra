...
## Strength Aesthetic — Legs focus (Fun) · 50-65 min
...
├─ 6 🍗 Standing Quad Stretch (explore, stay within constraints)
│  Set 1: ⛽ 60% × 6 (pattern prep)
Rest: 90s
═══
## 2) 🧈 Bread & Butter
Subcode: ⛽🌹🍗🟡 (Bread & Butter | Legs | Aesthetic | Fun)
├─ 5 🍗 Hack Squat (explore, stay within constraints)
...
├─ 5 🍗 Leg Extension Machine (try the unfamiliar version, explore the range)
│  Set 1: ⛽ 65% × 5 (discovery set)
Rest: 120s
═══
## 4) 🏖 Sandbox
Subcode: ⛽🌹🍗🟡 (Sandbox | Legs | Aesthetic | Fun)
├─ 5 🍗 Barbell Good Morning (explore within constraints, choose your variation)
