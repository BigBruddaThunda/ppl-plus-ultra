...
# 🍗 Dumbbell Romanian Deadlift — Posterior Chain Strength Log 🍗
...
Sub-block: ♨️🍗🌹🔵 (Warm-Up | Legs | Aesthetic | Structured)
...
Sub-block: ▶️🍗🌹🔵 (Primer | Legs | Aesthetic | Structured)

├─ Set 1: ⛽ 55% × 6 on Dumbbell Romanian Deadlift (find stance)
├─ Set 2: ⛽ 65% × 5 on Dumbbell Romanian Deadlift (steady descent)
└─ Set 3: ⛽ 72% × 4 on Dumbbell Romanian Deadlift (drive hard, no rush)
...
Sub-block: 🧈🍗🌹🔵 (Bread & Butter | Legs | Aesthetic | Structured)

├─ 5 🍗 Dumbbell Romanian Deadlift (deep range, strong finish)
│  ├─ Set 1: ⛽ 75% × 5
│  ├─ Set 2: ⛽ 78% × 5
│  ├─ Set 3: ⛽ 82% × 4
│  └─ Set 4: ⛽ 85% × 4
└─ 4 🍗 Leg Press (Standard) (tension never drops)
   ├─ Set 1: ⛽ 76% × 4
   ├─ Set 2: ⛽ 78% × 4
   └─ Set 3: ⛽ 80% × 4
...
Sub-block: 🧩🍗🌹🔵 (Supplemental | Legs | Aesthetic | Structured)

├─ 5 🍗 Seated Leg Curl (drive through mid-foot)
│  ├─ Set 1: ⛽ 75% × 5
│  ├─ Set 2: ⛽ 78% × 4
│  └─ Set 3: ⛽ 80% × 4
└─ 5 🍗 Leg Press Calf Raise (full stretch, full finish)
   ├─ Set 1: ⛽ 74% × 5
   ├─ Set 2: ⛽ 76% × 5
   └─ Set 3: ⛽ 78% × 4
...
Sub-block: 🪫🍗🌹🔵 (Release | Legs | Aesthetic | Structured)
...
Sub-block: 🚂🍗🌹🔵 (Junction | Legs | Aesthetic | Structured)
