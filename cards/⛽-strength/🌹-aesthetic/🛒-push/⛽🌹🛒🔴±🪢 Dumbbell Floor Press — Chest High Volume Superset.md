...
# 🛒 Dumbbell Floor Press — Chest High Volume Superset 🛒
...
Sub-block: ♨️🛒🌹🔴 (Warm-Up | Push | Aesthetic | Intense)
...
Sub-block: ▶️🛒🌹🔴 (Primer | Push | Aesthetic | Intense)

├─ Set 1: ⛽ 55% × 6 on Dumbbell Floor Press (control setup)
├─ Set 2: ⛽ 65% × 5 on Dumbbell Floor Press (smooth descent)
└─ Set 3: ⛽ 72% × 4 on Dumbbell Floor Press (clean drive)
...
Sub-block: 🧈🛒🌹🔴 (Bread & Butter | Push | Aesthetic | Intense)

├─ 5 🛒 Dumbbell Floor Press (full stretch, full finish)
│  ├─ Set 1: ⛽ 75% × 5
│  ├─ Set 2: ⛽ 78% × 5
│  ├─ Set 3: ⛽ 82% × 4
│  └─ Set 4: ⛽ 85% × 4
└─ 4 🛒 Weighted Chest Dip (keep shoulder quiet)
   ├─ Set 1: ⛽ 76% × 4
   ├─ Set 2: ⛽ 78% × 4
   └─ Set 3: ⛽ 80% × 4
...
Sub-block: 🧩🛒🌹🔴 (Supplemental | Push | Aesthetic | Intense)

├─ 5 🛒 Arnold Press (full ROM, smooth tempo)
│  ├─ Set 1: ⛽ 75% × 5
│  ├─ Set 2: ⛽ 78% × 4
│  └─ Set 3: ⛽ 80% × 4
└─ 5 🛒 Slow Eccentric Push-Up (5-second lower) (own the bottom)
   ├─ Set 1: ⛽ 74% × 5
   ├─ Set 2: ⛽ 76% × 5
   └─ Set 3: ⛽ 78% × 4
...
Sub-block: 🪫🛒🌹🔴 (Release | Push | Aesthetic | Intense)
...
Sub-block: 🚂🛒🌹🔴 (Junction | Push | Aesthetic | Intense)
