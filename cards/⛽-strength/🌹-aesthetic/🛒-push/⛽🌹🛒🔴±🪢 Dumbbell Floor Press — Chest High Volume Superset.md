...
blocks: ♨️ ▶️ 🧈 🧩 🪫 🚂
---
# 🛒 Dumbbell Floor Press — Push Intense 🛒

## Strength Aesthetic — Push focus (Intense) · 50-65 min
...
├─ 6 🛒 Medicine Ball Chest Pass (high effort, push the pace)
│  Set 1: ⛽ 60% × 6 (pattern prep)
Rest: 45s
═══
## 2) ▶️ Primer
Subcode: ⛽🌹🛒🔴 (Primer | Push | Aesthetic | Intense)
├─ 5 🛒 Sandbag Shouldering (tight setup, crisp intent)
│  Set 1: ⛽ 70% × 5 (activation)
Rest: 60s
═══
## 3) 🧈 Bread & Butter
Subcode: ⛽🌹🛒🔴 (Bread & Butter | Push | Aesthetic | Intense)
├─ 5 🛒 Dumbbell Floor Press (high effort, push the pace)
...
├─ 6 🛒 Face Pull to External Rotation (all-out, leave nothing in reserve)
...
├─ 6 🛒 Face Pull to External Rotation (stress out, cathartic discharge)
│  Set 1: ⛽ 60% × 6 (deload)
Rest: 60s
═══
## 7) 🚂 Junction
