...
blocks: ♨️ → ▶️ → 🧈 → 🪫 → 🚂 → 🧮
---
# 🍗 Barbell Hip Thrust — Legs Mindful 🍗

## Strength Basics — Legs focus (Mindful) · 50-65 min
...
├─ 5 🍗 Barbell Hip Thrust (4s eccentric, breath-paced)
...
├─ 6 🍗 Spanish Squat (Banded VMO) (parasympathetic, tension down, 4s eccentric)
│  Set 1: ⛽ 60% × 6 (deload)
Rest: 240s
═══
## 5) 🧬 Imprint
