...
├─ 6 🍗 Single-Leg Hip Thrust (Barbell) (explore, stay within constraints)
...
├─ 5 🍗 Single-Leg Balance Hold (try the unfamiliar version, explore the range)
│  Set 1: ⛽ 65% × 5 (discovery set)
Rest: 120s
═══
## 4) 🏖 Sandbox
Subcode: ⛽🏛🍗🟡 (Sandbox | Legs | Basics | Fun)
├─ 5 🍗 Single-Leg Balance with Perturbation (explore within constraints, choose your variation)
