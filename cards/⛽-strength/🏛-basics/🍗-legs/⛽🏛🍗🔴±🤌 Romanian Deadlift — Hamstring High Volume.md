...
blocks: ♨️ → ▶️ → 🧈 → 🧩 → 🌋 → 🪫 → 🚂 → 🧮
---
# 🍗 Back Squat (Glute Focus) — Legs Intense 🍗
...
├─ 6 🍗 Front Squat (Glute Activation) (high effort, push the pace)
...
├─ 5 🍗 Back Squat (Glute Focus) (high effort, push the pace)
...
├─ 6 🍗 Conventional Deadlift (Glute Load) (all-out, leave nothing in reserve)
...
├─ 6 🍗 Conventional Deadlift (Glute Load) (stress out, cathartic discharge)
│  Set 1: ⛽ 60% × 6 (deload)
Rest: 60s
═══
## 7) 🚂 Junction
