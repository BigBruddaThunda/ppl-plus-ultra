...
## Strength Basics — Pull focus (Fun) · 50-65 min
...
├─ 5 🪡 Half-Kneeling Band Single-Arm Pulldown (try the unfamiliar version, explore the range)
│  Set 1: ⛽ 65% × 5 (discovery set)
Rest: 120s
═══
## 4) 🏖 Sandbox
Subcode: ⛽🏛🪡🟡 (Sandbox | Pull | Basics | Fun)
├─ 5 🪡 One-Arm Dead Hang (explore within constraints, choose your variation)
...
├─ 6 🪡 Half-Kneeling Band Single-Arm Pulldown (smooth tempo, downshift)
│  Set 1: ⛽ 60% × 6 (deload)
Rest: 120s
═══
## 6) 🚂 Junction
