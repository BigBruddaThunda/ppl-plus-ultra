...
blocks: ♨️ → ▶️ → 🧈 → 🧩 → 🌋 → 🪫 → 🚂 → 🧮
---
# 🪡 Push Jerk (Barbell) — Pull Intense 🪡

## Strength Basics — Pull focus (Intense) · 50-65 min

**CODE:** ⛽🏛🪡🔴

> "Push the ceiling. Every set should cost something real."

*Powerlifting: Heavy working sets with full recovery — push the ceiling, earn every rep*
═══
## 1) ♨️ Warm-Up — 🤌 facio
Subcode: ⛽🏛🪡🔴 (Warm-Up | Pull | Basics | Intense)
├─ 6 🪡 Log Press (high effort, push the pace)
...
├─ 5 🪡 Push Jerk (Barbell) (high effort, push the pace)
...
├─ 6 🪡 Power Snatch (all-out, leave nothing in reserve)
...
├─ 6 🪡 Power Snatch (stress out, cathartic discharge)
│  Set 1: ⛽ 60% × 6 (deload)
Rest: 60s
═══
## 7) 🚂 Junction
