...
## Strength Basics — Plus focus (Intense) · 50-65 min
...
├─ 6 ➕ Single-Leg Broad Jump (all-out, leave nothing in reserve)
...
├─ 6 ➕ Single-Leg Broad Jump (stress out, cathartic discharge)
│  Set 1: ⛽ 60% × 6 (deload)
Rest: 60s
═══
## 7) 🚂 Junction
