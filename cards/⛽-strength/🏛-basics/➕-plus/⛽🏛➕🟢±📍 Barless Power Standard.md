...
blocks: ♨️ → ▶️ → 🧈 → 🧩 → 🚂 → 🧮
---
# ➕ Pull-Up (Overhand Grip) — Plus Bodyweight ➕

## Strength Basics — Plus focus (Bodyweight) · 50-65 min
...
├─ 6 ➕ Chin-Up (Underhand Grip) (bodyweight, no external load needed)
...
├─ 5 ➕ Pull-Up (Overhand Grip) (bodyweight, no external load needed)
