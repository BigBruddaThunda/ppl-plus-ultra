...
*Active Recovery: Teaches what recovery feels like — coaching the nervous system, not the muscles*
═══
## 1) ♨️ Warm-Up — 📍 pono
Subcode: ⛽🏛➕⚫ (Warm-Up | Plus | Basics | Teaching)
├─ 6 ➕ Walking High Knees (coached, check form before adding load)
│  Set 1: ⛽ 60% × 6 (pattern prep)
Rest: 135s
═══
## 2) 🛠 Craft
Subcode: ⛽🏛➕⚫ (Craft | Plus | Basics | Teaching)
├─ 5 ➕ Walking Butt Kicks (coach: check grip width, elbow angle, foot pressure)
