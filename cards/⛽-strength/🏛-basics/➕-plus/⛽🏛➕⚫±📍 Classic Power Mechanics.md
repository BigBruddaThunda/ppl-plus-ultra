...
blocks: ♨️ → 🛠 → 🧈 → 🧩 → 🚂 → 🧮
---
# ➕ Classic Power Mechanics — Plus Teaching ➕

## Strength Basics — Plus focus (Teaching) · 50-65 min
...
├─ 6 ➕ Rotational Medicine Ball Throw (coached, check form before adding load)
│  Set 1: ⛽ 60% × 6 (pattern prep)
Rest: 135s
═══
## 2) 🛠 Craft
Subcode: ⛽🏛➕⚫ (Craft | Plus | Basics | Teaching)
├─ 5 ➕ Side Plank with Hip Dip (coach: check grip width, elbow angle, foot pressure)
...
├─ 5 ➕ Classic Power Mechanics (coached, check form before adding load)
...
├─ 6 ➕ Scapular Push-Up (Serratus) (full range, different angle)
...
├─ 6 ➕ Pull-Up (Overhand Grip) (high rep, low load, neural memory)
