...
## Strength Time — Ultra focus (Fun) · 50-65 min
...
├─ 6 ➖ Sprint (30-60 meters) (explore, stay within constraints)
│  Set 1: ⛽ 60% × 6 (pattern prep)
Rest: 90s
═══
## 2) 🧈 Bread & Butter
Subcode: ⛽⌛➖🟡 (Bread & Butter | Ultra | Time | Fun)
├─ 5 ➖ Sprint (10-30 meters) (explore, stay within constraints)
...
├─ 5 ➖ Hill Sprint (Long) (try the unfamiliar version, explore the range)
│  Set 1: ⛽ 65% × 5 (discovery set)
Rest: 120s
═══
## 4) 🏖 Sandbox
Subcode: ⛽⌛➖🟡 (Sandbox | Ultra | Time | Fun)
├─ 5 ➖ Tempo Run (Moderate Pace) (explore within constraints, choose your variation)
...
├─ 6 ➖ Hill Sprint (Long) (smooth tempo, downshift)
│  Set 1: ⛽ 60% × 6 (deload)
Rest: 120s
═══
## 6) 🚂 Junction
