...
# ➕ Slam and Carry Rotation — Power Station Circuit ➕
...
Sub-block: ♨️➕⌛🟠 (Warm-Up | Plus | Time | Circuit)
...
Sub-block: ▶️➕⌛🟠 (Primer | Plus | Time | Circuit)
...
Primary Rotation: **Medicine Ball Slam**

✒️ grapho — 🎱 loop the stations under clock pressure

Sub-block: 🎱➕⌛🟠 (ARAM | Plus | Time | Circuit)

- ➕ Medicine Ball Slam (start each minute sharp)
...
Sub-block: 🧩➕⌛🟠 (Supplemental | Plus | Time | Circuit)
