...
blocks: ♨️ ▶️ 🧈 🧩 🪫 🚂
---
# 🪡 Barbell Row EMOM — Pull Teaching 🪡

## Strength Time — Pull focus (Teaching) · 50-65 min
...
═══
## 2) 🛠 Craft
Subcode: ⛽⌛🪡⚫ (Craft | Pull | Time | Teaching)
...
├─ 5 🪡 Barbell Row EMOM (coached, check form before adding load)
...
═══
## 4) 🧩 Supplemental
Subcode: ⛽⌛🪡⚫ (Supplemental | Pull | Time | Teaching)
