...
## Strength Functional — Pull focus (Structured) · 50-65 min
...
├─ 6 🪡 Single-Arm Lat Pulldown (prescribed, track sets and reps)
│  Set 1: ⛽ 60% × 6 (pattern prep)
Rest: 90s
═══
## 2) ▶️ Primer
Subcode: ⛽🔨🪡🔵 (Primer | Pull | Functional | Structured)
├─ 5 🪡 Single-Arm Dumbbell Row (tight setup, crisp intent)
│  Set 1: ⛽ 70% × 5 (activation)
Rest: 120s
═══
## 3) 🧈 Bread & Butter
Subcode: ⛽🔨🪡🔵 (Bread & Butter | Pull | Functional | Structured)
├─ 5 🪡 Archer Pull-Up (prescribed, track sets and reps)
...
├─ 6 🪡 Plank Row (Single-Arm) (full range, different angle)
