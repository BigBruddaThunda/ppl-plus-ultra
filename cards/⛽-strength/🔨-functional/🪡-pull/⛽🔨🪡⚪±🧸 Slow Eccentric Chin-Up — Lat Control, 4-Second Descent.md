...
## Strength Functional — Pull focus (Mindful) · 50-65 min
...
├─ 6 🪡 Single-Arm Lat Pulldown (parasympathetic, tension down, 4s eccentric)
│  Set 1: ⛽ 60% × 6 (deload)
Rest: 240s
═══
## 5) 🧬 Imprint
Subcode: ⛽🔨🪡⚪ (Imprint | Pull | Functional | Mindful)
├─ 6 🪡 Single-Arm Face Pull (high rep, low load, neural memory)
