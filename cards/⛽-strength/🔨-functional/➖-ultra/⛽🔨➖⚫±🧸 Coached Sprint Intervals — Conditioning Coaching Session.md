...
## Strength Functional — Ultra focus (Teaching) · 50-65 min
...
├─ 5 ➖ Kettlebell Swing (Alternating Arms) (coach: check grip width, elbow angle, foot pressure)
...
├─ 6 ➖ Alternating Kettlebell Snatch (high rep, low load, neural memory)
