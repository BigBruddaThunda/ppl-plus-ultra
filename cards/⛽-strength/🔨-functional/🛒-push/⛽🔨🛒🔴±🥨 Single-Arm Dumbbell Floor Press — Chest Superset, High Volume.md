...
## Strength Functional — Push focus (Intense) · 50-65 min
...
├─ 6 🛒 Depth Push-Up (Drop to Floor) (high effort, push the pace)
...
├─ 5 🛒 Plyometric Push-Up (Hands Leave Ground) (high effort, push the pace)
...
├─ 6 🛒 Log Press (all-out, leave nothing in reserve)
...
├─ 6 🛒 Log Press (stress out, cathartic discharge)
│  Set 1: ⛽ 60% × 6 (deload)
Rest: 60s
═══
## 7) 🚂 Junction
