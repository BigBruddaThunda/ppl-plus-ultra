...
blocks: ♨️ → ▶️ → 🛠 → 🧈 → 🧩 → 🚂
---
# 🛒 Standing Dumbbell Press — Push Teaching 🛒

## Strength Functional — Push focus (Teaching) · 50-65 min
...
├─ 6 🛒 Single-Arm Incline Dumbbell Press (coached, check form before adding load)
│  Set 1: ⛽ 60% × 6 (pattern prep)
Rest: 135s
═══
## 2) 🛠 Craft
Subcode: ⛽🔨🛒⚫ (Craft | Push | Functional | Teaching)
├─ 5 🛒 Single-Arm Cable Press (coach: check grip width, elbow angle, foot pressure)
...
├─ 5 🛒 Standing Dumbbell Press (coached, check form before adding load)
...
├─ 6 🛒 Diamond Push-Up (high rep, low load, neural memory)
