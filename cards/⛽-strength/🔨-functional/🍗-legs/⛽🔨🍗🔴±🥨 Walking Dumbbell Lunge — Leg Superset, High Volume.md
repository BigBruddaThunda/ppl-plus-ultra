...
## Strength Functional — Legs focus (Intense) · 50-65 min
...
═══
## 1) ♨️ Warm-Up — 🥨 tendo (extend/push limits)
Subcode: ⛽🔨🍗🔴 (Warm-Up | Legs | Functional | Intense)
├─ 6 🍗 Single-Leg Jump Rope (high effort, push the pace)
│  Set 1: ⛽ 60% × 6 (pattern prep)
Rest: 45s
═══
## 2) ▶️ Primer
Subcode: ⛽🔨🍗🔴 (Primer | Legs | Functional | Intense)
├─ 5 🍗 Bulgarian Split Squat (Glute Emphasis) (tight setup, crisp intent)
│  Set 1: ⛽ 70% × 5 (activation)
Rest: 60s
═══
## 3) 🧈 Bread & Butter
Subcode: ⛽🔨🍗🔴 (Bread & Butter | Legs | Functional | Intense)
├─ 5 🍗 Single-Leg Pogo Hops (high effort, push the pace)
...
═══
## 4) 🧩 Supplemental
Subcode: ⛽🔨🍗🔴 (Supplemental | Legs | Functional | Intense)
...
═══
## 5) 🌋 Gutter
Subcode: ⛽🔨🍗🔴 (Gutter | Legs | Functional | Intense)
├─ 6 🍗 Single-Leg Squat (Pistol - Glute Med Load) (all-out, leave nothing in reserve)
│  Set 1: ⛽ 65% × 6 (push to form break)
│  Set 2: ⛽ 65% × AMRAP (final effort)
Rest: 45s
═══
## 6) 🪫 Release
Subcode: ⛽🔨🍗🔴 (Release | Legs | Functional | Intense)
├─ 6 🍗 Single-Leg Squat (Pistol - Glute Med Load) (stress out, cathartic discharge)
│  Set 1: ⛽ 60% × 6 (deload)
Rest: 60s
═══
## 7) 🚂 Junction
