...
## Foundation Functional — Legs focus (Intense) · 40-50 min
...
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🔨🍗🔴 (Fundamentals | Legs | Functional | Intense)
...
├─ 11 🍗 Single-Leg Curl (Seated) (high effort, push the pace)
...
═══
## 5) 🧬 Imprint
Subcode: 🐂🔨🍗🔴 (Imprint | Legs | Functional | Intense)
├─ 15 🍗 Half-Kneeling Hip Flexor Stretch (high rep, low load, neural memory)
