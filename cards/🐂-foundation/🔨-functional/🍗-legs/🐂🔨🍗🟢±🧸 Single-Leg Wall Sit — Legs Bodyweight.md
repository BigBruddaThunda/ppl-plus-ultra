...
## Foundation Functional — Legs focus (Bodyweight) · 40-50 min
...
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🔨🍗🟢 (Fundamentals | Legs | Functional | Bodyweight)
├─ 12 🍗 Single-Leg Hip Thrust (Bodyweight) (slow, own each position)
...
├─ 13 🍗 Single-Leg Glute Bridge (full range, different angle)
│  Set 1: 🐂 55% × 13 (support volume)
│  Set 2: 🐂 55% × 13 (non-redundant)
Rest: 60s
═══
## 5) 🧬 Imprint
Subcode: 🐂🔨🍗🟢 (Imprint | Legs | Functional | Bodyweight)
