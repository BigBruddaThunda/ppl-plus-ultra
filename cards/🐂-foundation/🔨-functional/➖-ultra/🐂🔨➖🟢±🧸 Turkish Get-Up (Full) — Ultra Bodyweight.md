...
## Foundation Functional — Ultra focus (Bodyweight) · 40-50 min
...
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🔨➖🟢 (Fundamentals | Ultra | Functional | Bodyweight)
...
├─ 11 ➖ Turkish Get-Up (Full) (bodyweight, no external load needed)
...
├─ 13 ➖ Turkish Get-Up (Full) (full range, different angle)
│  Set 1: 🐂 55% × 13 (support volume)
│  Set 2: 🐂 55% × 13 (non-redundant)
Rest: 60s
═══
## 5) 🧬 Imprint
Subcode: 🐂🔨➖🟢 (Imprint | Ultra | Functional | Bodyweight)
├─ 15 ➖ Turkish Get-Up (To Seated) (high rep, low load, neural memory)
