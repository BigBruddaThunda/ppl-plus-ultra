...
## Foundation Functional — Plus focus (Mindful) · 40-50 min
...
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🔨➕⚪ (Fundamentals | Plus | Functional | Mindful)
├─ 12 ➕ Aquaman (Alternating Superman) (slow, own each position)
...
├─ 15 ➕ Wide-Grip Lat Pulldown (Teres Focus) (high rep, low load, neural memory)
