...
blocks: ♨️ 🔢/🛠 🧈 🧩 🧬 🚂
---
# ➕ One-Arm Deadlift — Plus Intense ➕

## Foundation Functional — Plus focus (Intense) · 40-50 min
...
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🔨➕🔴 (Fundamentals | Plus | Functional | Intense)
...
├─ 11 ➕ One-Arm Deadlift (high effort, push the pace)
...
═══
## 5) 🧬 Imprint
Subcode: 🐂🔨➕🔴 (Imprint | Plus | Functional | Intense)
├─ 15 ➕ Archer Pull-Up (high rep, low load, neural memory)
