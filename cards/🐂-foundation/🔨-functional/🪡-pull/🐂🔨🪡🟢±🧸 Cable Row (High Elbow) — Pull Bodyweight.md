...
## Foundation Functional — Pull focus (Bodyweight) · 40-50 min
...
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🔨🪡🟢 (Fundamentals | Pull | Functional | Bodyweight)
...
═══
## 4) 🧩 Supplemental
Subcode: 🐂🔨🪡🟢 (Supplemental | Pull | Functional | Bodyweight)
...
═══
## 5) 🧬 Imprint
Subcode: 🐂🔨🪡🟢 (Imprint | Pull | Functional | Bodyweight)
