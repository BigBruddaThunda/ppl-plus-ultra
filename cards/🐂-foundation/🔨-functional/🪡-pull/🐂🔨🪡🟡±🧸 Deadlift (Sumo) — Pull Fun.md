...
blocks: ♨️ 🔢/🛠 🧈 🧩 🧬 🚂
---
# 🪡 Deadlift (Sumo) — Pull Fun 🪡

## Foundation Functional — Pull focus (Fun) · 40-50 min
...
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🔨🪡🟡 (Fundamentals | Pull | Functional | Fun)
...
├─ 11 🪡 Deadlift (Sumo) (explore, stay within constraints)
...
═══
## 4) 🧩 Supplemental
Subcode: 🐂🔨🪡🟡 (Supplemental | Pull | Functional | Fun)
...
═══
## 5) 🧬 Imprint
Subcode: 🐂🔨🪡🟡 (Imprint | Pull | Functional | Fun)
...
├─ 11 🪡 Alternating Dumbbell Front Raise (explore within constraints, structured play)
│  Set 1: 🐂 55% × 11 (discovery)
Rest: 60s
═══
## 7) 🚂 Junction
