...
├─ 12 🪡 Single-Arm Cable Rear Delt Fly (slow, own each position)
...
├─ 13 🪡 Sandbag Shouldering (full range, different angle)
...
├─ 15 🪡 Single-Arm Overhead Dumbbell Hold (high rep, low load, neural memory)
