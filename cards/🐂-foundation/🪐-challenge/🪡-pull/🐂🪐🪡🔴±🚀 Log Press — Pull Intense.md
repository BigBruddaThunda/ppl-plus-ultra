...
blocks: ♨️ 🔢/🛠 🧈 🧩 🧬 🚂
---
# 🪡 Log Press — Pull Intense 🪡

## Foundation Challenge — Pull focus (Intense) · 40-50 min
...
├─ 12 🪡 Push Jerk (Barbell) (high effort, push the pace)
│  Set 1: 🐂 45% × 12 (pattern prep)
Rest: 30s
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🪐🪡🔴 (Fundamentals | Pull | Challenge | Intense)
├─ 12 🪡 Zercher Carry (slow, own each position)
...
═══
## 5) 🧬 Imprint
Subcode: 🐂🪐🪡🔴 (Imprint | Pull | Challenge | Intense)
├─ 15 🪡 Back Squat (Glute Focus) (high rep, low load, neural memory)
