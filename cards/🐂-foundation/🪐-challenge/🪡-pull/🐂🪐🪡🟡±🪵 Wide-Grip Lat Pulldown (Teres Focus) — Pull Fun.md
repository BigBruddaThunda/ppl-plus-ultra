...
## Foundation Challenge — Pull focus (Fun) · 40-50 min
...
├─ 11 🪡 Single-Arm Face Pull (explore, stay within constraints)
...
├─ 11 🪡 Single-Arm Lat Pulldown (try the unfamiliar version, explore the range)
│  Set 1: 🐂 50% × 11 (discovery set)
Rest: 60s
═══
## 4) 🏖 Sandbox
Subcode: 🐂🪐🪡🟡 (Sandbox | Pull | Challenge | Fun)
├─ 11 🪡 Single-Arm Face Pull (explore within constraints, choose your variation)
