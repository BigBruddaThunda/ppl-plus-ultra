...
## Foundation Challenge — Push focus (Intense) · 40-50 min
...
├─ 12 🛒 Plyometric Push-Up (Hands Leave Ground) (high effort, push the pace)
│  Set 1: 🐂 45% × 12 (pattern prep)
Rest: 60s
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🪐🛒🔴 (Fundamentals | Push | Challenge | Intense)
├─ 12 🛒 Push Jerk (Barbell) (slow, own each position)
...
├─ 11 🛒 Log Press (high effort, push the pace)
...
├─ 13 🛒 Bamboo Bar Bench Press (full range, different angle)
│  Set 1: 🐂 55% × 13 (support volume)
│  Set 2: 🐂 55% × 13 (non-redundant)
Rest: 60s
═══
## 5) 🧬 Imprint
Subcode: 🐂🪐🛒🔴 (Imprint | Push | Challenge | Intense)
