...
blocks: ♨️ 🔢/🛠 🧈 🧩 🧬 🚂
---
# ➕ Chin-Up (Underhand Grip) — Plus Structured ➕

## Foundation Challenge — Plus focus (Structured) · 40-50 min
...
├─ 12 ➕ Pull-Up (Overhand Grip) (prescribed, track sets and reps)
│  Set 1: 🐂 45% × 12 (pattern prep)
Rest: 60s
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🪐➕🔵 (Fundamentals | Plus | Challenge | Structured)
...
├─ 11 ➕ Chin-Up (Underhand Grip) (prescribed, track sets and reps)
...
├─ 13 ➕ Rotational Medicine Ball Throw (full range, different angle)
│  Set 1: 🐂 55% × 13 (support volume)
│  Set 2: 🐂 55% × 13 (non-redundant)
Rest: 60s
═══
## 5) 🧬 Imprint
Subcode: 🐂🪐➕🔵 (Imprint | Plus | Challenge | Structured)
├─ 15 ➕ Chest-Supported Row (Elbow Out) (high rep, low load, neural memory)
