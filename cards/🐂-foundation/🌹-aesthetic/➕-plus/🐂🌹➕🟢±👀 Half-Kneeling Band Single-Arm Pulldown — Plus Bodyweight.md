...
## Foundation Aesthetic — Plus focus (Bodyweight) · 40-50 min
...
├─ 12 ➕ Kettlebell Swing (Two-Hand) (bodyweight, no external load needed)
│  Set 1: 🐂 45% × 12 (pattern prep)
Rest: 60s
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🌹➕🟢 (Fundamentals | Plus | Aesthetic | Bodyweight)
├─ 12 ➕ American Swing (Overhead) (slow, own each position)
...
═══
## 5) 🧬 Imprint
Subcode: 🐂🌹➕🟢 (Imprint | Plus | Aesthetic | Bodyweight)
