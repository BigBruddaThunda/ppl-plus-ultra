...
blocks: ♨️ 🔢/🛠 🧈 🧩 🧬 🚂
---
# ➕ Cable Row (Rhomboid Focus - Elbows In) — Plus Structured ➕

## Foundation Partner — Plus focus (Structured) · 40-50 min
...
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🐬➕🔵 (Fundamentals | Plus | Partner | Structured)
...
├─ 15 ➕ Cable Row (High Elbow) (high rep, low load, neural memory)
