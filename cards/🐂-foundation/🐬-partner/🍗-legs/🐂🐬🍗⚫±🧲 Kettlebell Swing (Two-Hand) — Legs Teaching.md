...
blocks: ♨️ 🔢/🛠 🧈 🧩 🧬 🚂
---
# 🍗 Kettlebell Swing (Two-Hand) — Legs Teaching 🍗
...
├─ 12 🍗 Deep Squat Hold (Ankle Mobility) (coached, check form before adding load)
│  Set 1: 🐂 45% × 12 (pattern prep)
Rest: 60s
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🐬🍗⚫ (Fundamentals | Legs | Partner | Teaching)
