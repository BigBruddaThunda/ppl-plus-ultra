...
## Foundation Partner — Legs focus (Teaching) · 40-50 min

**CODE:** 🐂🐬🍗⚫

> "Practice the positions slowly. This is a coaching session, not a workout."

*Calisthenics Strength: Teaches barbell setup, loading sequence, and safety positions for heavy compound lifts*
═══
## 1) ♨️ Warm-Up — 🧲 capio
Subcode: 🐂🐬🍗⚫ (Warm-Up | Legs | Partner | Teaching)
├─ 12 🍗 Box Jump (Calf Power) (coached, check form before adding load)
│  Set 1: 🐂 45% × 12 (pattern prep)
Rest: 90s
═══
## 2) 🛠 Craft
Subcode: 🐂🐬🍗⚫ (Craft | Legs | Partner | Teaching)
├─ 11 🍗 Depth Drop (Reactive Calf) (coach: check grip width, elbow angle, foot pressure)
│  Set 1: 🐂 45% × 11 (practice the pattern, not the load)
│  Set 2: 🐂 50% × 11 (same cues, slightly heavier)
Rest: 112s
═══
## 3) 🧈 Bread & Butter
Subcode: 🐂🐬🍗⚫ (Bread & Butter | Legs | Partner | Teaching)
├─ 11 🍗 Single-Leg Jump Rope (coached, check form before adding load)
...
═══
## 4) 🧩 Supplemental
Subcode: 🐂🐬🍗⚫ (Supplemental | Legs | Partner | Teaching)
...
═══
## 5) 🧬 Imprint
Subcode: 🐂🐬🍗⚫ (Imprint | Legs | Partner | Teaching)
