...
blocks: ♨️ 🔢/🛠 🧈 🧩 🧬 🚂
---
# 🍗 Half-Kneeling Hip Flexor Stretch — Legs Fun 🍗

## Foundation Partner — Legs focus (Fun) · 40-50 min
...
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🐬🍗🟡 (Fundamentals | Legs | Partner | Fun)
├─ 12 🍗 Leg Press Calf Raise (slow, own each position)
...
├─ 11 🍗 Half-Kneeling Hip Flexor Stretch (explore, stay within constraints)
...
═══
## 4) 🧩 Supplemental
Subcode: 🐂🐬🍗🟡 (Supplemental | Legs | Partner | Fun)
...
═══
## 5) 🧬 Imprint
Subcode: 🐂🐬🍗🟡 (Imprint | Legs | Partner | Fun)
