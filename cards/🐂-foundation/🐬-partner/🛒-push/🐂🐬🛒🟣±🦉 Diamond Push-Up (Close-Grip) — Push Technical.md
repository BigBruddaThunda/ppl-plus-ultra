...
blocks: ♨️ 🔢/🛠 🧈 🧩 🧬 🚂
---
# 🛒 Diamond Push-Up (Close-Grip) — Push Technical 🛒

## Foundation Partner — Push focus (Technical) · 40-50 min
...
├─ 12 🛒 Incline Barbell Bench Press (30°) (precision, quality over volume)
│  Set 1: 🐂 45% × 12 (pattern prep)
Rest: 90s
═══
## 2) ▶️ Primer
Subcode: 🐂🐬🛒🟣 (Primer | Push | Partner | Technical)
├─ 11 🛒 Smith Machine Incline Press (tight setup, crisp intent)
│  Set 1: 🐂 55% × 11 (activation)
Rest: 112s
═══
## 3) 🧈 Bread & Butter
Subcode: 🐂🐬🛒🟣 (Bread & Butter | Push | Partner | Technical)
├─ 11 🛒 Diamond Push-Up (Close-Grip) (precision, quality over volume)
