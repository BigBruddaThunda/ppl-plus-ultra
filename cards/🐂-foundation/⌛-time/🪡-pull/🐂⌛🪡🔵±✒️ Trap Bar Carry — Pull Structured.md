...
## Foundation Time — Pull focus (Structured) · 40-50 min
...
├─ 12 🪡 Aquaman (Alternating Superman) (prescribed, track sets and reps)
│  Set 1: 🐂 45% × 12 (pattern prep)
Rest: 60s
═══
## 2) 🔢 Fundamentals
Subcode: 🐂⌛🪡🔵 (Fundamentals | Pull | Time | Structured)
├─ 12 🪡 Half-Kneeling Band Single-Arm Pulldown (slow, own each position)
...
├─ 11 🪡 Single-Arm Face Pull (prescribed, track sets and reps)
...
├─ 13 🪡 Pull-Up (Overhand Grip) (full range, different angle)
│  Set 1: 🐂 55% × 13 (support volume)
│  Set 2: 🐂 55% × 13 (non-redundant)
Rest: 60s
═══
## 5) 🧬 Imprint
Subcode: 🐂⌛🪡🔵 (Imprint | Pull | Time | Structured)
├─ 15 🪡 Wide-Grip Pull-Up (high rep, low load, neural memory)
