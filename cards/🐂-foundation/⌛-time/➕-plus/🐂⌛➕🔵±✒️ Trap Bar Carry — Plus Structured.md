...
## Foundation Time — Plus focus (Structured) · 40-50 min
...
═══
## 2) 🔢 Fundamentals
Subcode: 🐂⌛➕🔵 (Fundamentals | Plus | Time | Structured)
...
├─ 11 ➕ Single-Leg Hops Through Ladder (prescribed, track sets and reps)
...
═══
## 5) 🧬 Imprint
Subcode: 🐂⌛➕🔵 (Imprint | Plus | Time | Structured)
├─ 15 ➕ Single-Arm Plank (high rep, low load, neural memory)
