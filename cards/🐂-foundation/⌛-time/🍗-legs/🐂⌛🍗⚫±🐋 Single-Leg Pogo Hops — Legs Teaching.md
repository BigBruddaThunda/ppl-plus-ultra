...
## Foundation Time — Legs focus (Teaching) · 40-50 min
...
═══
## 2) 🔢 Fundamentals
Subcode: 🐂⌛🍗⚫ (Fundamentals | Legs | Time | Teaching)
├─ 12 🍗 Standing Quad Stretch (slow, own each position)
...
├─ 11 🍗 Single-Leg Pogo Hops (coached, check form before adding load)
