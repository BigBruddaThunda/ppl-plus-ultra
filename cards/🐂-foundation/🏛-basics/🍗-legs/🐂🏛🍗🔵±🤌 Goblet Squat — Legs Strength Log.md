...
blocks: ♨️ → 🔢/🛠 → 🧈 → 🧩 → 🧬 → 🚂 → 🧮
---
# 🍗 Goblet Squat — Legs Structured 🍗

## Foundation Basics — Legs focus (Structured) · 40-50 min
...
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🏛🍗🔵 (Fundamentals | Legs | Basics | Structured)
...
├─ 11 🍗 Goblet Squat (prescribed, track sets and reps)
...
═══
## 5) 🧬 Imprint
Subcode: 🐂🏛🍗🔵 (Imprint | Legs | Basics | Structured)
