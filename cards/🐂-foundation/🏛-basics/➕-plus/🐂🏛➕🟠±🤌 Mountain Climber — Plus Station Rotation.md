...
# ➕ Mountain Climber — Plus Station Rotation ➕
...
Sub-block: 🐂🏛➕🟠 (Warm-Up | Plus | Basics | Circuit)
...
Sub-block: 🐂🏛➕🟠 (Aram | Plus | Basics | No barbell)
...
Sub-block: 🐂🏛➕🟠 (ARAM | Plus | Basics | Station rotation)

├─ 12 ➕ Mountain Climber (clean setup, own the full range)
...
Sub-block: 🐂🏛➕🟠 (Supplemental | Plus | Basics | Station alternation)
