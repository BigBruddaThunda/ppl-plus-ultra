...
blocks: ♨️ → 🔢/🛠 → 🧈 → 🧩 → 🧬 → 🚂 → 🧮
---
# ➕ Suitcase Carry (Single-Arm) — Plus Structured ➕

## Foundation Basics — Plus focus (Structured) · 40-50 min
...
├─ 12 ➕ Rotational Medicine Ball Throw (prescribed, track sets and reps)
│  Set 1: 🐂 45% × 12 (pattern prep)
Rest: 60s
═══
## 2) 🔢 Fundamentals
Subcode: 🐂🏛➕🔵 (Fundamentals | Plus | Basics | Structured)
├─ 12 ➕ Side Plank with Hip Dip (slow, own each position)
...
├─ 11 ➕ Suitcase Carry (Single-Arm) (prescribed, track sets and reps)
...
├─ 13 ➕ Scapular Push-Up (Serratus) (full range, different angle)
│  Set 1: 🐂 55% × 13 (support volume)
│  Set 2: 🐂 55% × 13 (non-redundant)
Rest: 60s
═══
## 5) 🧬 Imprint
Subcode: 🐂🏛➕🔵 (Imprint | Plus | Basics | Structured)
