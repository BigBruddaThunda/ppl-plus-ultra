...
**Do not act on seeds unless instructed.** Each seed becomes active when its phase is reached and Jake Berry confirms it is ready to build.

Seeds live here rather than in whiteboard.md because they have cleared the ideation threshold. They are real. They just aren't Phase 2 or 3.

---

## Planted Seeds

| File | Description | Planted | Status |
|------|-------------|---------|--------|
| default-rotation-engine.md | 3-gear daily zip system: Order by weekday, Type by rolling calendar, Axis by month | 2026-02-20 | SEED |
...
## Seed Status Conventions

- **SEED** — Planted. Reviewed. Not yet active work.
- **GROWING** — Phase has arrived. Active development in progress.
- **HARVESTED** — Built and integrated. Seed file archived.
