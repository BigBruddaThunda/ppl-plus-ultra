...
| Bus | Factorio / Kaizen | A shared backbone that carries directives and state to dependent subsystems. In PPL: CLAUDE.md + scl-directory.md function as the main bus for generation logic, while systems-glossary.md carries the vocabulary bus that keeps terms canonical across docs and tooling. |
