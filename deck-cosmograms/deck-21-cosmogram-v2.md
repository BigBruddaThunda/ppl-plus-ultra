...
Performance operates as the deck's developmental law, while Aesthetic acts as the interpretive lens. In this room, material is admitted only if it survives the what's my actual capacity? test and can be read through the allegorical sense. The departmental posture is deliberate: define the load-bearing facts first, then widen into adjacent fields.

The Liberal Art × hermeneutic collision here is Arithmetic × Allegorical. That pairing sets an academic temperament: structured inquiry, explicit terms, and accountable interpretation. The Corinthian column and Jun–Aug season cues make this deck feel architectural and temporal at the same time — a syllabus with a calendar, not a loose notebook.

The operator pair 👀 specio / 🦢 plico supplies the action vocabulary. Preparatory work names, positions, receives, or inspects; expressive work executes, extends, launches, or documents. Read like a university department charter: what we teach, how we test it, and how knowledge leaves the room.
...
Notes:
- Chosen for Performance × Aesthetic gravity; next pass should add named deposits and canonical sources on this branch.
- Track cross-links with 🏟 Performance and 🌹 Aesthetic to prevent duplicate subject clusters across neighboring decks.
...
- [MISO] Performance-Aesthetic Curriculum Studio — CONTEMPORARY
...
- 🌹 Aesthetic and 🛠 Craft converge on pedagogy: lens and apprenticeship determine quality thresholds.
- 👀 specio to 🦢 plico defines a curriculum path from intake to publication.
...
Richest branches: 🏟, 🌹, 🐂, ⛽, 🦋
Thinnest branches: ♨️, 🎯, 🔢, 🧈, 🫀
Needs web research: prioritize 🏟 Performance, 🌹 Aesthetic, and operator branches 👀/🦢 for named traditions, institutions, and bibliographies.
