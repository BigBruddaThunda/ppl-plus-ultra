...
column: Corinthian
season: Jun–Aug
deep-question: "What's my actual capacity?"
status: DRAFT
branch-count: 61
subject-count: 152
session-count: 1
...
Performance operates as the deck's developmental law, while Challenge acts as the interpretive lens. In this room, material is admitted only if it survives the what's my actual capacity? test and can be read through the anagogical sense. The departmental posture is deliberate: define the load-bearing facts first, then widen into adjacent fields.

The Liberal Art × hermeneutic collision here is Arithmetic × Anagogical. That pairing sets an academic temperament: structured inquiry, explicit terms, and accountable interpretation. The Corinthian column and Jun–Aug season cues make this deck feel architectural and temporal at the same time — a syllabus with a calendar, not a loose notebook.

The operator pair 🪵 teneo / 🚀 mitto supplies the action vocabulary. Preparatory work names, positions, receives, or inspects; expressive work executes, extends, launches, or documents. Read like a university department charter: what we teach, how we test it, and how knowledge leaves the room.
...
Notes:
- Chosen for Performance × Challenge gravity; next pass should add named deposits and canonical sources on this branch.
- Track cross-links with 🏟 Performance and 🪐 Challenge to prevent duplicate subject clusters across neighboring decks.
...
- [MISO] Performance-Challenge Curriculum Studio — CONTEMPORARY
...
- 🏟 Performance and 🧈 Bread & Butter converge around core-canon design: what is central in this deck becomes teachable method.
- 🪐 Challenge and 🛠 Craft converge on pedagogy: lens and apprenticeship determine quality thresholds.
- 🪵 teneo to 🚀 mitto defines a curriculum path from intake to publication.
...
Richest branches: 🏟, 🪐, 🐂, ⛽, 🦋
Thinnest branches: ♨️, 🎯, 🔢, 🧈, 🫀
Needs web research: prioritize 🏟 Performance, 🪐 Challenge, and operator branches 🪵/🚀 for named traditions, institutions, and bibliographies.
