...
Foundation operates as the deck's developmental law, while Basics acts as the interpretive lens. In this room, material is admitted only if it survives the what are the pieces? test and can be read through the literal sense. The departmental posture is deliberate: define the load-bearing facts first, then widen into adjacent fields.

The Liberal Art × hermeneutic collision here is Grammar × Literal. That pairing sets an academic temperament: structured inquiry, explicit terms, and accountable interpretation. The Tuscan column and Jan–Feb season cues make this deck feel architectural and temporal at the same time — a syllabus with a calendar, not a loose notebook.
...
- [MISO] Foundation-Basics Curriculum Studio — CONTEMPORARY

Notes:
- Chosen for Foundation × Basics gravity; next pass should add named deposits and canonical sources on this branch.
- Track cross-links with 🐂 Foundation and 🏛 Basics to prevent duplicate subject clusters across neighboring decks.
...
Richest branches: 🐂, 🏛, ⛽, 🦋, 🏟
Thinnest branches: ♨️, 🎯, 🔢, 🧈, 🫀
Needs web research: prioritize 🐂 Foundation, 🏛 Basics, and operator branches 📍/🤌 for named traditions, institutions, and bibliographies.
