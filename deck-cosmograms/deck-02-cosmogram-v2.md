...
# Deck 02 Cosmogram — 🐂 Foundation × 🔨 Functional

## Deck Character

Foundation operates as the deck's developmental law, while Functional acts as the interpretive lens. In this room, material is admitted only if it survives the what are the pieces? test and can be read through the moral sense. The departmental posture is deliberate: define the load-bearing facts first, then widen into adjacent fields.

The Liberal Art × hermeneutic collision here is Grammar × Moral. That pairing sets an academic temperament: structured inquiry, explicit terms, and accountable interpretation. The Tuscan column and Jan–Feb season cues make this deck feel architectural and temporal at the same time — a syllabus with a calendar, not a loose notebook.
...
- [MISO] Foundation-Functional Curriculum Studio — CONTEMPORARY

Notes:
- Chosen for Foundation × Functional gravity; next pass should add named deposits and canonical sources on this branch.
- Track cross-links with 🐂 Foundation and 🔨 Functional to prevent duplicate subject clusters across neighboring decks.
...
Richest branches: 🐂, 🔨, ⛽, 🦋, 🏟
Thinnest branches: ♨️, 🎯, 🔢, 🧈, 🫀
Needs web research: prioritize 🐂 Foundation, 🔨 Functional, and operator branches 🧸/🥨 for named traditions, institutions, and bibliographies.
