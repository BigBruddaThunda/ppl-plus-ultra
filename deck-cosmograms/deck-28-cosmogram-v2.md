...
column: Composite
season: Aug–Oct
deep-question: "Does it all fit together?"
status: DRAFT
branch-count: 61
subject-count: 152
session-count: 1
...
Full Body operates as the deck's developmental law, while Challenge acts as the interpretive lens. In this room, material is admitted only if it survives the does it all fit together? test and can be read through the anagogical sense. The departmental posture is deliberate: define the load-bearing facts first, then widen into adjacent fields.

The Liberal Art × hermeneutic collision here is Geometry × Anagogical. That pairing sets an academic temperament: structured inquiry, explicit terms, and accountable interpretation. The Composite column and Aug–Oct season cues make this deck feel architectural and temporal at the same time — a syllabus with a calendar, not a loose notebook.
...
Notes:
- Chosen for Full Body × Challenge gravity; next pass should add named deposits and canonical sources on this branch.
- Track cross-links with 🌾 Full Body and 🪐 Challenge to prevent duplicate subject clusters across neighboring decks.
...
- [MISO] Full Body-Challenge Curriculum Studio — CONTEMPORARY
...
- 🌾 Full Body and 🧈 Bread & Butter converge around core-canon design: what is central in this deck becomes teachable method.
...
Richest branches: 🌾, 🪐, 🐂, ⛽, 🦋
Thinnest branches: ♨️, 🎯, 🔢, 🧈, 🫀
Needs web research: prioritize 🌾 Full Body, 🪐 Challenge, and operator branches 🪵/🚀 for named traditions, institutions, and bibliographies.
