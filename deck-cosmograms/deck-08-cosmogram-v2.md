...
Strength operates as the deck's developmental law, while Functional acts as the interpretive lens. In this room, material is admitted only if it survives the what's true under pressure? test and can be read through the moral sense. The departmental posture is deliberate: define the load-bearing facts first, then widen into adjacent fields.

The Liberal Art × hermeneutic collision here is Logic × Moral. That pairing sets an academic temperament: structured inquiry, explicit terms, and accountable interpretation. The Doric column and Feb–Apr season cues make this deck feel architectural and temporal at the same time — a syllabus with a calendar, not a loose notebook.
...
Notes:
- Chosen for Strength × Functional gravity; next pass should add named deposits and canonical sources on this branch.
- Track cross-links with ⛽ Strength and 🔨 Functional to prevent duplicate subject clusters across neighboring decks.
...
- [MISO] Strength-Functional Curriculum Studio — CONTEMPORARY
...
Richest branches: ⛽, 🔨, 🐂, 🦋, 🏟
Thinnest branches: ♨️, 🎯, 🔢, 🧈, 🫀
Needs web research: prioritize ⛽ Strength, 🔨 Functional, and operator branches 🧸/🥨 for named traditions, institutions, and bibliographies.
