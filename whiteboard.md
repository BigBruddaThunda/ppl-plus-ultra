...
| DONE | — | Negentropy thesis seed | — | seeds/negentropy-thesis.md — hollow template, live constraint solver, zip-as-communication, multi-timescale recalculation, ergodic property |
| DONE | — | Architectural reset direction seed | — | seeds/architectural-reset-direction.md — what tightens when the system rebuilds, ripple map across all seeds, directional constraints |
